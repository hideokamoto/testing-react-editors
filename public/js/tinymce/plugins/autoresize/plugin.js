...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_514kz693jnlf41iu.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_514kz693jnlf41iu.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_514kz693jnlf41iu.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_514kz693jnlf41iu.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_514kz693jnlf41iu.getAutoResizeBottomMargin(editor);
    ...
    if ($_514kz693jnlf41iu.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_10vg4s90jnlf41iq.resize(editor, oldSize);
    });
  };
  var $_6eojt58zjnlf41ip = { register: register };

  global.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_6eojt58zjnlf41ip.register(editor, oldSize);
      $_10vg4s90jnlf41iq.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
