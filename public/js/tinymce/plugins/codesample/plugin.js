...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_46odnagjnlf41ok.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_ataszzabjnlf41n4.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_169zzpadjnlf41n6.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_2kzxngahjnlf41ol = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_67tvz8aajnlf41n2 = {
    open: function (editor) {
      var minWidth = $_ataszzabjnlf41n4.getDialogMinWidth(editor);
      var minHeight = $_ataszzabjnlf41n4.getDialogMinHeight(editor);
      var currentLanguage = $_2kzxngahjnlf41ol.getCurrentLanguage(editor);
      var currentLanguages = $_2kzxngahjnlf41ol.getLanguages(editor);
      var currentCode = $_169zzpadjnlf41n6.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_169zzpadjnlf41n6.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_46odnagjnlf41ok.isCodeSample(node)) {
        $_67tvz8aajnlf41n2.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_6c89hua9jnlf41my = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_46odnagjnlf41ok.trimArg($_46odnagjnlf41ok.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_46odnagjnlf41ok.trimArg($_46odnagjnlf41ok.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_bu5wk0aijnlf41om = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_ataszzabjnlf41n4.getContentCss(editor);
  ...
  var $_8amblajjnlf41oo = { loadCss: loadCss };
  ...
  var $_582wjtakjnlf41oq = { register: register$1 };

  var addedInlineCss = Cell(false);
  global.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_bu5wk0aijnlf41om.setup(editor);
    $_582wjtakjnlf41oq.register(editor);
    $_6c89hua9jnlf41my.register(editor);
    editor.on('init', function () {
      $_8amblajjnlf41oo.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_46odnagjnlf41ok.isCodeSample(ev.target)) {
        $_67tvz8aajnlf41n2.open(editor);
      }
    });
  });
