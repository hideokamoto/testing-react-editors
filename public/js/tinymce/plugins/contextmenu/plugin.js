...
var contextmenu = (function () {
  ...
  var $_7rgcnmavjnlf41qp = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_79s5hmaujnlf41qn.getContextMenu(editor);
  ...
  var $_50kmueayjnlf41qt = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_79s5hmaujnlf41qn.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_50kmueayjnlf41qt.show(editor, $_7rgcnmavjnlf41qp.getPos(editor, e), visibleState, menu);
    });
  };
  var $_b7vbwdatjnlf41ql = { setup: setup };

  global.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_b7vbwdatjnlf41ql.setup(editor, visibleState, menu);
    return $_e7mmmoasjnlf41qj.get(visibleState);
  });
  function Plugin () {
  }
