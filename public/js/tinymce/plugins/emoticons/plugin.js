...
var emoticons = (function () {
  ...
  var $_12ph6ybajnlf41rs = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_12ph6ybajnlf41rs.getHtml(pluginUrl);
  ...
  var $_2kx5lnb9jnlf41rq = { register: register };

  global.add('emoticons', function (editor, pluginUrl) {
    $_2kx5lnb9jnlf41rq.register(editor, pluginUrl);
  });
  function Plugin () {
  }
