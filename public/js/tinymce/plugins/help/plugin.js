...
var help = (function () {
  ...
  var $_b989fabmjnlf41so = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = map($_b989fabmjnlf41so.shortcuts, function (shortcut) {
  ...
  var $_5n33r8bgjnlf41s5 = { makeTab: makeTab };
  ...
  var $_4kja6wbojnlf41sq = { makeTab: makeTab$1 };
  ...
  var $_682vkubujnlf41tf = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_5n33r8bgjnlf41s5.makeTab(),
          $_4kja6wbojnlf41sq.makeTab(editor)
        ],
        buttons: $_682vkubujnlf41tf.makeRow(),
  ...
  var $_24ntzjbfjnlf41s3 = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_24ntzjbfjnlf41s3.open(editor, pluginUrl));
  };
  var $_dabuiybejnlf41s1 = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_24ntzjbfjnlf41s3.open(editor, pluginUrl)
    });
  ...
  var $_2rmqdfbwjnlf41tk = { register: register$1 };

  global.add('help', function (editor, pluginUrl) {
    $_2rmqdfbwjnlf41tk.register(editor, pluginUrl);
    $_dabuiybejnlf41s1.register(editor, pluginUrl);
