...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_f2x2x8fcjnlf42er.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_f2x2x8fcjnlf42er.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_f2x2x8fcjnlf42er.getSelectorConverter(editor)) {
      selectorConverter = $_f2x2x8fcjnlf42er.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_f2x2x8fcjnlf42er.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_f2x2x8fcjnlf42er.getCssGroups(editor));
      ...
      if (!$_f2x2x8fcjnlf42er.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      global$4.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_f2x2x8fcjnlf42er.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_32muiaf7jnlf42el.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_d2nr8gf6jnlf42ej = { get: get };

  global.add('importcss', function (editor) {
    $_32muiaf7jnlf42el.setup(editor);
    return $_d2nr8gf6jnlf42ej.get(editor);
  });
  function Plugin () {
  }
