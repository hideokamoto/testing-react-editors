...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_34wjqujfjnlf42tp.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_34wjqujfjnlf42tp.getPreviewDialogWidth(editor);
    var dialogHeight = $_34wjqujfjnlf42tp.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_8icqqfjgjnlf42tq.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_axrku3jdjnlf42tn = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_axrku3jdjnlf42tn.open(editor);
    });
  };
  var $_oowjzjcjnlf42tm = { register: register };
  ...
  var $_ep7yw3jijnlf42ts = { register: register$1 };

  global.add('preview', function (editor) {
    $_oowjzjcjnlf42tm.register(editor);
    $_ep7yw3jijnlf42ts.register(editor);
  });
  function Plugin () {
  }
