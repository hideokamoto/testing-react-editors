...
var textpattern = (function () {
  ...
  var $_d0d8b0rtjnlf45ug = { getPatterns: getPatterns };
  ...
  var patternFromRng = function (patterns, rng, space) {
    ...
    var endPattern = $_9n3k0ps1jnlf45ut.findEndPattern(patterns, text, rng.startOffset, delta);
    ...
    var startPattern = $_9n3k0ps1jnlf45ut.findPattern(patterns, patternRng.toString());
  ...
  var applyBlockFormat = function (editor, patterns) {
    ...
    if (textBlockElm) {
      ...
      if (firstTextNode) {
        pattern = $_9n3k0ps1jnlf45ut.findPattern(patterns, firstTextNode.data);
        if (!pattern) {
          return;
        }
  ...
  function handleEnter(editor, patterns) {
    ...
    wrappedTextNode = $_af6xngryjnlf45uo.applyInlineFormatEnter(editor, patterns);
    if (wrappedTextNode) {
    ...
    $_af6xngryjnlf45uo.applyBlockFormat(editor, patterns);
  }
  function handleInlineKey(editor, patterns) {
    var wrappedTextNode, lastChar, lastCharNode, rng, dom;
    wrappedTextNode = $_af6xngryjnlf45uo.applyInlineFormatSpace(editor, patterns);
    if (wrappedTextNode) {
      dom = editor.dom;
  ...
  var setup = function (editor, patternsState) {
    ...
    editor.on('keydown', function (e) {
      if (e.keyCode === 13 && !global$2.modifierPressed(e)) {
        $_5o1hagrxjnlf45uj.handleEnter(editor, patternsState.get());
      }
    }, true);
    editor.on('keyup', function (e) {
      if ($_5o1hagrxjnlf45uj.checkKeyCode(keyCodes, e)) {
        $_5o1hagrxjnlf45uj.handleInlineKey(editor, patternsState.get());
      }
    });
    editor.on('keypress', function (e) {
      if ($_5o1hagrxjnlf45uj.checkCharCode(charCodes, e)) {
  ...
  var $_5367jorujnlf45uh = { setup: setup };

  global.add('textpattern', function (editor) {
    var patternsState = Cell($_d0d8b0rtjnlf45ug.getPatterns(editor.settings));
    $_5367jorujnlf45uh.setup(editor, patternsState);
    return $_fv32mtrsjnlf45ug.get(patternsState);
  });
  function Plugin () {
  }
