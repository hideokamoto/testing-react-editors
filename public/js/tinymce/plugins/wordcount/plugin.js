...
var wordcount = (function () {
  ...
  var $_anvpjutljnlf461b = {
    each: each,
    map: map
  };

  var SETS$1 = $_6uda9ztjjnlf4614.SETS;
  var OTHER = $_6uda9ztjjnlf4614.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_anvpjutljnlf461b.map(string.split(''), memoized);
  };
  var $_ddy5tmtkjnlf4619 = { classify: classify };

  var ci = $_6uda9ztjjnlf4614.characterIndices;
  ...
  var $_4yqofvtmjnlf461d = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_6uda9ztjjnlf4614.EMPTY_STRING;
  var WHITESPACE$1 = $_6uda9ztjjnlf4614.WHITESPACE;
  var PUNCTUATION$1 = $_6uda9ztjjnlf4614.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_ddy5tmtkjnlf4619.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_4yqofvtmjnlf461d.isWordBoundary(map, i)) {
  ...
  var $_7paiiwtijnlf4612 = { getWords: getWords };
  ...
  var getCount = function (editor) {
    return $_7paiiwtijnlf4612.getWords(getTextContent(editor)).length;
  };
  var $_4e5p95tfjnlf460z = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_4e5p95tfjnlf460z.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_a8ttsgtejnlf460y = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return global$4.translate([
        '{0} words',
        $_4e5p95tfjnlf460z.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_dz17j7tnjnlf461g = { setup: setup };

  global.add('wordcount', function (editor) {
    $_dz17j7tnjnlf461g.setup(editor);
    return $_a8ttsgtejnlf460y.get(editor);
  });
  function Plugin () {
  }
