...
var inlite = (function () {
  ...
  var $_3bg5up17zjnlf4bzx = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_92k8xo183jnlf4c01.fromClientRect(clientRect)) : null;
  };
  var $_6dayo4182jnlf4c00 = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          var result = $_3bjgjm181jnlf4bzz.result(predicateIds[i].id, $_6dayo4182jnlf4c00.getElementRect(editor, element));
          return result;
        }
      }
      return null;
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_3bjgjm181jnlf4bzz.result(predicateIds[x].id, $_6dayo4182jnlf4c00.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        var result = $_3bjgjm181jnlf4bzz.result(id, $_6dayo4182jnlf4c00.getSelectionRect(editor));
        return result;
      }
      return null;
    };
      ...
      for (i = 0; i < elements.length; i++) {
        if (elements[i].nodeName in textBlockElementsMap) {
          if (editor.dom.isEmpty(elements[i])) {
            return $_3bjgjm181jnlf4bzz.result(id, $_6dayo4182jnlf4c00.getSelectionRect(editor));
          }
          return null;
        }
      }
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_abzicj18cjnlf4c0b.isArray(value)) {
      return value;
    } else if ($_abzicj18cjnlf4c0b.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_abzicj18cjnlf4c0b.isBoolean(value)) {
  ...
  var $_ecaxmf18bjnlf4c0a = {
    getStringOr: getByTypeOr($_abzicj18cjnlf4c0b.isString),
    getBoolOr: getByTypeOr($_abzicj18cjnlf4c0b.isBoolean),
    getNumberOr: getByTypeOr($_abzicj18cjnlf4c0b.isNumber),
    getHandlerOr: getByTypeOr($_abzicj18cjnlf4c0b.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_abzicj18cjnlf4c0b.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_92k8xo183jnlf4c01.toClientRect(targetRect),
        contentAreaRect: $_92k8xo183jnlf4c01.toClientRect(contentAreaRect),
        panelRect: $_92k8xo183jnlf4c01.toClientRect(panelRect)
      });
      return $_92k8xo183jnlf4c01.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_ecaxmf18bjnlf4c0a.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_ecaxmf18bjnlf4c0a.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_ecaxmf18bjnlf4c0a.getHandlerOr(editor, 'inline_toolbar_position_handler', $_56rpkz18djnlf4c0d.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_7ytu9c188jnlf4c07.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_916rrv189jnlf4c08.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_916rrv189jnlf4c08.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_c3quy7187jnlf4c06 = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_3bg5up17zjnlf4bzx.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_5f2ivg184jnlf4c02.fromContextToolbars(toolbars);
    result = $_3bjgjm181jnlf4bzz.match(editor, [
      $_2bz5jt180jnlf4bzy.element(elements[0], contextToolbarsPredicateIds),
      $_9kxrjo186jnlf4c04.textSelection('text'),
      $_9kxrjo186jnlf4c04.emptyTextBlock(elements, 'insert'),
      $_2bz5jt180jnlf4bzy.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_3bjgjm181jnlf4bzz.match(editor, [$_9kxrjo186jnlf4c04.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_c3quy7187jnlf4c06.load(editor, function () {
  ...
  var $_4wf39s17vjnlf4bzu = { renderUI: renderUI };
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self$$1.borderBox = $_47fkde18rjnlf4c1z.parseBox(settings.border);
      self$$1.paddingBox = $_47fkde18rjnlf4c1z.parseBox(settings.padding);
      self$$1.marginBox = $_47fkde18rjnlf4c1z.parseBox(settings.margin);
      if (settings.hidden) {
        self$$1.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_6xjx4v18zjnlf4c2d.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self$$1.borderBox = self$$1.borderBox || $_47fkde18rjnlf4c1z.measureBox(elm, 'border');
      self$$1.paddingBox = self$$1.paddingBox || $_47fkde18rjnlf4c1z.measureBox(elm, 'padding');
      self$$1.marginBox = self$$1.marginBox || $_47fkde18rjnlf4c1z.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_9mhob518yjnlf4c2c.remove(this);
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_6xjx4v18zjnlf4c2d.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_6xjx4v18zjnlf4c2d.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_7il6e9190jnlf4c2j = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_6xjx4v18zjnlf4c2d.getUiContainer(self$$1);
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_6xjx4v18zjnlf4c2d.inheritUiContainer(this, this._tooltip);
  ...
  var Window$$1 = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self$$1._fullscreen) {
        ...
        if (!state) {
          self$$1.borderBox = $_47fkde18rjnlf4c1z.parseBox(self$$1.settings.border);
          ...
          self$$1.borderBox = $_47fkde18rjnlf4c1z.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_4wf39s17vjnlf4bzu.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_28au4x17ujnlf4bzt = { get: get };
  ...
  var $_di2haf19ijnlf4c40 = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_di2haf19ijnlf4c40.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_bo61ih19gjnlf4c3t = { blobToBase64: blobToBase64 };
  ...
  var $_fdkrcd19mjnlf4c48 = { pickFile: pickFile };
  ...
  var $_5we3di19ojnlf4c4g = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_582jlt19qjnlf4c4i.create(dom, selection.getRng());
    global$4.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_582jlt19qjnlf4c4i.resolve(dom, bookmark));
  };
  ...
  var $_5isrgo19pjnlf4c4h = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_5we3di19ojnlf4c4g.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_5isrgo19pjnlf4c4h.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_4avjt19njnlf4c4e.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_fdkrcd19mjnlf4c48.pickFile().then(function (files) {
          var blob = files[0];
          $_bo61ih19gjnlf4c3t.blobToBase64(blob).then(function (base64) {
            $_4avjt19njnlf4c4e.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_4avjt19njnlf4c4e.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_6doqkj19fjnlf4c3s = { addToEditor: addToEditor };
  ...
  var $_848ztq19ujnlf4c4o = { getUiContainerDelta: getUiContainerDelta$1 };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_a8hru319wjnlf4c4v.isAbsolute(href) && $_a8hru319wjnlf4c4v.isDomainLike(href) ? askAboutPrefix(editor, href) : global$12.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_4avjt19njnlf4c4e.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_4avjt19njnlf4c4e.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_43gzkf19vjnlf4c4t = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_abzicj18cjnlf4c0b.isArray(items)) {
      return items;
    } else if ($_abzicj18cjnlf4c0b.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
    ...
    global$4.each(itemsToArray$1(items), function (item) {
      if (item === '|') {
        ...
        if (editor.buttons[item]) {
          ...
          if ($_abzicj18cjnlf4c0b.isFunction(button)) {
            button = button();
          }
  ...
  var $_f28eqt19xjnlf4c4w = { create: create$2 };

  var create$3 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return global$4.map(toolbars, function (toolbar) {
        return $_f28eqt19xjnlf4c4w.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_f28eqt19xjnlf4c4w.create(editor, 'text', $_916rrv189jnlf4c08.getTextSelectionToolbarItems(editor)),
        $_f28eqt19xjnlf4c4w.create(editor, 'insert', $_916rrv189jnlf4c08.getInsertToolbarItems(editor)),
        $_43gzkf19vjnlf4c4t.createQuickLinkForm(editor, hide)
      ]);
      return global$11.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_916rrv189jnlf4c08.getPositionHandler(editor);
      contentAreaRect = $_6dayo4182jnlf4c00.getContentAreaRect(editor);
      panelRect = global$2.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_56rpkz18djnlf4c0d.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_56rpkz18djnlf4c0d.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_848ztq19ujnlf4c4o.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_56rpkz18djnlf4c0d.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_6dayo4182jnlf4c00.getContentAreaRect(editor);
        panelRect = global$2.DOM.getRect(panel.getEl());
        result = $_56rpkz18djnlf4c0d.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_56rpkz18djnlf4c0d.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_7ytu9c188jnlf4c07.fireBeforeRenderUI(editor);
  ...
  var isComment = function (element) {
    return type(element) === $_fxpjv71arjnlf4c81.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$2($_fxpjv71arjnlf4c81.ELEMENT);
  var isText = isType$2($_fxpjv71arjnlf4c81.TEXT);
  var isDocument = isType$2($_fxpjv71arjnlf4c81.DOCUMENT);
  var $_3hqrk11aqjnlf4c80 = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_3hqrk11aqjnlf4c80.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_64idic1ayjnlf4c99 = { toArray: toArray };

  var node = function () {
    var f = $_di2haf19ijnlf4c40.getOrDie('Node');
    return f;
  };
  ...
  var $_870k2a1b1jnlf4ca1 = { detect: detect$3 };

  var ELEMENT = $_fxpjv71arjnlf4c81.ELEMENT;
  var DOCUMENT = $_fxpjv71arjnlf4c81.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_563gvu1b0jnlf4c9x.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_870k2a1b1jnlf4ca1.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_dgpij31azjnlf4c9a = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_8265gw1bcjnlf4cbg.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_dgpij31azjnlf4c9a.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_dgpij31azjnlf4c9a.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_64idic1ayjnlf4c99.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_64idic1ayjnlf4c99.toArray(element, nextSibling);
  };
  ...
  var all$1 = function (predicate) {
    return descendants($_eqz571aojnlf4c7t.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_7n03891asjnlf4c84.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_7n03891asjnlf4c84.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_7n03891asjnlf4c84.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each($_7n03891asjnlf4c84.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_8265gw1bcjnlf4cbg.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_8koode1anjnlf4c7m.ancestors(scope, function (e) {
      return $_8265gw1bcjnlf4cbg.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_8koode1anjnlf4c7m.siblings(scope, function (e) {
      return $_8265gw1bcjnlf4cbg.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_8koode1anjnlf4c7m.children(scope, function (e) {
      return $_8265gw1bcjnlf4cbg.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_8265gw1bcjnlf4cbg.all(selector, scope);
  };
  var $_9p24rl1amjnlf4c7l = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return map($_9p24rl1amjnlf4c7l.descendants(Element$$1.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var $_5fv32g1ajjnlf4c6e = { find: find$3 };
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_5fv32g1ajjnlf4c6e.find(bodyElm);
  ...
  var first$1 = function (predicate) {
    return descendant($_eqz571aojnlf4c7t.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_dgpij31azjnlf4c9a.eq(scope, x) && predicate(x);
    });
  };
  ...
  var first$2 = function (selector) {
    return $_8265gw1bcjnlf4cbg.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_54q3aq1bijnlf4cce.ancestor(scope, function (e) {
      return $_8265gw1bcjnlf4cbg.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_54q3aq1bijnlf4cce.sibling(scope, function (e) {
      return $_8265gw1bcjnlf4cbg.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_54q3aq1bijnlf4cce.child(scope, function (e) {
      return $_8265gw1bcjnlf4cbg.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_8265gw1bcjnlf4cbg.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_8265gw1bcjnlf4cbg.is, ancestor$1, scope, selector, isRoot);
  };
  var $_5keixi1bhjnlf4cca = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
  ...
  var $_3esr9j1bkjnlf4cdh = { register: register };
  ...
  var $_790pm41bmjnlf4cdk = { register: register$1 };
  ...
  var $_dnqdn41bnjnlf4cdm = { register: register$2 };
  ...
  var $_9hx9iq1bojnlf4cdo = { register: register$3 };
  ...
  var $_5xtu0f1bpjnlf4cdr = { register: register$4 };
  ...
  var $_ao7jg01bqjnlf4cdu = { register: register$5 };
  ...
  var $_64f8bv1brjnlf4cdz = { register: register$6 };
  ...
  var $_10iap31bsjnlf4ce1 = { register: register$7 };
  ...
  var $_emf7ag1btjnlf4ce3 = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$1.container = $_5keixi1bhjnlf4cca.descendant(Element$$1.fromDom(document.body), editor.settings.ui_container).fold(constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_5xtu0f1bpjnlf4cdr.register(editor);
    $_3esr9j1bkjnlf4cdh.register(editor);
    $_64f8bv1brjnlf4cdz.register(editor);
    $_10iap31bsjnlf4ce1.register(editor);
    $_dnqdn41bnjnlf4cdm.register(editor);
    $_790pm41bmjnlf4cdk.register(editor);
    $_9hx9iq1bojnlf4cdo.register(editor);
    $_emf7ag1btjnlf4ce3.register(editor);
    $_ao7jg01bqjnlf4cdu.register(editor);
  };
  var $_92p8hf1bgjnlf4cbz = { setup: setup };
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_9mhob518yjnlf4c2c,
      Control: Control$1,
      Factory: global$11,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_7insrt19cjnlf4c3k,
      Panel: Panel,
      Movable: $_7il6e9190jnlf4c2j,
      Resizable: $_btrtwc19djnlf4c3n,
      ...
      FormatControls: $_92p8hf1bgjnlf4cbz,
  ...
  global.add('inlite', function (editor) {
    var panel = create$3();
    $_92p8hf1bgjnlf4cbz.setup(editor);
    $_6doqkj19fjnlf4c3s.addToEditor(editor, panel);
    return $_28au4x17ujnlf4bzt.get(editor, panel);
  });
  function Theme () {
  }
