...
var mobile = (function () {
  ...
  var $_fzox1py5jnlf46zr = { detect: detect$3 };
  ...
  var tap = alloy.tap;
  var tapOrClick = $_fzox1py5jnlf46zr.detect().deviceType.isTouch() ? alloy.tap : click;
  ...
  var isComment = function (element) {
    return type(element) === $_gj73igynjnlf473p.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_gj73igynjnlf473p.ELEMENT);
  var isText = isType$1($_gj73igynjnlf473p.TEXT);
  var isDocument = isType$1($_gj73igynjnlf473p.DOCUMENT);
  var $_40epr8ymjnlf473o = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_40epr8ymjnlf473o.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_55t4icyujnlf4751 = { toArray: toArray };
  ...
  var $_18n9jdyxjnlf475q = { getOrDie: getOrDie };

  var node = function () {
    var f = $_18n9jdyxjnlf475q.getOrDie('Node');
    return f;
  };
  ...
  var $_3538xyywjnlf475p = {
    documentPositionPreceding: documentPositionPreceding,
    documentPositionContainedBy: documentPositionContainedBy
  };

  var ELEMENT = $_gj73igynjnlf473p.ELEMENT;
  var DOCUMENT = $_gj73igynjnlf473p.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_3538xyywjnlf475p.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_fzox1py5jnlf46zr.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_cyaumpyvjnlf4752 = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_2zt1o6z0jnlf475z.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_cyaumpyvjnlf4752.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_cyaumpyvjnlf4752.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_55t4icyujnlf4751.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_55t4icyujnlf4751.toArray(element, nextSibling);
  };
  ...
  var before = function (marker, element) {
    var parent = $_4on2xtypjnlf473t.parent(marker);
    parent.each(function (v) {
      v.dom().insertBefore(element.dom(), marker.dom());
    });
  };
  var after = function (marker, element) {
    var sibling = $_4on2xtypjnlf473t.nextSibling(marker);
  ...
  var prepend = function (parent, element) {
    var firstChild = $_4on2xtypjnlf473t.firstChild(parent);
  ...
  var appendAt = function (parent, element, index) {
    $_4on2xtypjnlf473t.child(parent, index).fold(function () {
      append(parent, element);
    }, function (v) {
      before(v, element);
    });
  ...
  var before$1 = function (marker, elements) {
    each$1(elements, function (x) {
      $_8lnrdpyojnlf473r.before(marker, x);
    });
  };
  var after$1 = function (marker, elements) {
    each$1(elements, function (x, i) {
      var e = i === 0 ? marker : elements[i - 1];
      $_8lnrdpyojnlf473r.after(e, x);
    });
  };
  var prepend$1 = function (parent, elements) {
    each$1(elements.slice().reverse(), function (x) {
      $_8lnrdpyojnlf473r.prepend(parent, x);
    });
  };
  var append$1 = function (parent, elements) {
    each$1(elements, function (x) {
      $_8lnrdpyojnlf473r.append(parent, x);
    });
  };
  var $_4zppfzz2jnlf476k = {
    before: before$1,
    after: after$1,
    prepend: prepend$1,
    append: append$1
  ...
  var empty = function (element) {
    ...
    each$1($_4on2xtypjnlf473t.children(element), function (rogue) {
      remove(rogue);
    });
  };
  ...
  var unwrap = function (wrapper) {
    var children = $_4on2xtypjnlf473t.children(wrapper);
    if (children.length > 0)
      $_4zppfzz2jnlf476k.before(wrapper, children);
    remove(wrapper);
  };
  var $_181c7wz1jnlf476d = {
    empty: empty,
    remove: remove,
    unwrap: unwrap
  };
  ...
  var attach = function (parent, child) {
    attachWith(parent, child, $_8lnrdpyojnlf473r.append);
  };
  var attachWith = function (parent, child, insertion) {
    parent.getSystem().addToWorld(child);
    insertion(parent.element(), child.element());
    if ($_49tkmtykjnlf4732.inBody(parent.element())) {
      fireAttaching(child);
    }
  ...
  var doDetach = function (component) {
    ...
    $_181c7wz1jnlf476d.remove(component.element());
    component.getSystem().removeFromWorld(component);
  };
  var detach = function (component) {
    var parent = $_4on2xtypjnlf473t.parent(component.element()).bind(function (p) {
  ...
  var detachChildren = function (component) {
    ...
    $_181c7wz1jnlf476d.empty(component.element());
    component.syncComponents();
  };
  var attachSystem = function (element, guiSystem) {
    $_8lnrdpyojnlf473r.append(element, guiSystem.element());
    var children = $_4on2xtypjnlf473t.children(guiSystem.element());
  ...
  var json = function () {
    return $_18n9jdyxjnlf475q.getOrDie('JSON');
  };
  ...
  var $_776w81zjjnlf47cr = {
    parse: parse,
    stringify: stringify
  };

  var formatObj = function (input) {
    return isObject(input) && keys(input).length > 100 ? ' removed due to size' : $_776w81zjjnlf47cr.stringify(input, null, 2);
  };
  ...
  var isSource = function (component, simulatedEvent) {
    return $_cyaumpyvjnlf4752.eq(component.element(), simulatedEvent.event().target());
  };

  var nu$4 = function (parts) {
    if (!hasKey$1(parts, 'can') && !hasKey$1(parts, 'abort') && !hasKey$1(parts, 'run')) {
      throw new Error('EventHandler defined by: ' + $_776w81zjjnlf47cr.stringify(parts, null, 2) + ' does not have can, abort, or run!');
    }
  ...
  var defToStr = function (defn) {
    ...
    return $_776w81zjjnlf47cr.stringify(raw, null, 2);
  };
  var defToRaw = function (defn) {
    return {
      ...
      defChildren: defn.defChildren().fold(function () {
        ...
        return $_776w81zjjnlf47cr.stringify(d, null, 2);
      }),
  ...
  var transfer = function (source, destination, attrs) {
    if (!$_40epr8ymjnlf473o.isElement(source) || !$_40epr8ymjnlf473o.isElement(destination))
      return;
    each$1(attrs, function (attr) {
      transferOne(source, destination, attr);
    });
  };
  var $_2u3dwzyjnlf47ja = {
    clone: clone,
    set: set,
    setAll: setAll,
    get: get$1,
  ...
  var read$1 = function (element, attr) {
    var value = $_2u3dwzyjnlf47ja.get(element, attr);
    return value === undefined || value === '' ? [] : value.split(' ');
  };
  var add = function (element, attr, id) {
    var old = read$1(element, attr);
    var nu = old.concat([id]);
    $_2u3dwzyjnlf47ja.set(element, attr, nu.join(' '));
    return true;
  };
  var remove$2 = function (element, attr, id) {
    ...
    if (nu.length > 0)
      ...
      $_2u3dwzyjnlf47ja.remove(element, attr);
    return false;
  };
  var $_2uage1100jnlf47k4 = {
    read: read$1,
    add: add,
    remove: remove$2
  };
  ...
  var get$2 = function (element) {
    return $_2uage1100jnlf47k4.read(element, 'class');
  };
  var add$1 = function (element, clazz) {
    return $_2uage1100jnlf47k4.add(element, 'class', clazz);
  };
  var remove$3 = function (element, clazz) {
    return $_2uage1100jnlf47k4.remove(element, 'class', clazz);
  };
  ...
  var add$2 = function (element, clazz) {
    if ($_6eyngwzzjnlf47jt.supports(element))
      element.dom().classList.add(clazz);
    else
      $_6eyngwzzjnlf47jt.add(element, clazz);
  };
  var cleanClass = function (element) {
    var classList = $_6eyngwzzjnlf47jt.supports(element) ? element.dom().classList : $_6eyngwzzjnlf47jt.get(element);
    if (classList.length === 0) {
      $_2u3dwzyjnlf47ja.remove(element, 'class');
    }
  };
  var remove$4 = function (element, clazz) {
    if ($_6eyngwzzjnlf47jt.supports(element)) {
      ...
      $_6eyngwzzjnlf47jt.remove(element, clazz);
    cleanClass(element);
  };
  var toggle$1 = function (element, clazz) {
    return $_6eyngwzzjnlf47jt.supports(element) ? element.dom().classList.toggle(clazz) : $_6eyngwzzjnlf47jt.toggle(element, clazz);
  };
  var toggler = function (element, clazz) {
    var hasClasslist = $_6eyngwzzjnlf47jt.supports(element);
    var classList = element.dom().classList;
    var off = function () {
      if (hasClasslist)
        classList.remove(clazz);
  ...
  var has$2 = function (element, clazz) {
    return $_6eyngwzzjnlf47jt.supports(element) && element.dom().classList.contains(clazz);
  };
  var $_4fn1o3zwjnlf47j8 = {
    add: add$2,
    remove: remove$4,
    toggle: toggle$1,
    toggler: toggler,
  ...
  var swap = function (element, addCls, removeCls) {
    $_4fn1o3zwjnlf47j8.remove(element, removeCls);
    $_4fn1o3zwjnlf47j8.add(element, addCls);
  };
  ...
  var clear = function (component, swapConfig, swapState) {
    $_4fn1o3zwjnlf47j8.remove(component.element(), swapConfig.alpha());
    $_4fn1o3zwjnlf47j8.remove(component.element(), swapConfig.omega());
  };
  var isAlpha = function (component, swapConfig, swapState) {
    return $_4fn1o3zwjnlf47j8.has(component.element(), swapConfig.alpha());
  };
  var isOmega = function (component, swapConfig, swapState) {
    return $_4fn1o3zwjnlf47j8.has(component.element(), swapConfig.omega());
  };
  ...
  var first$1 = function (predicate) {
    return descendant($_49tkmtykjnlf4732.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_cyaumpyvjnlf4752.eq(scope, x) && predicate(x);
    });
  };
  ...
  var any$1 = function (predicate) {
    return $_gim1dr105jnlf47l0.first(predicate).isSome();
  };
  var ancestor$1 = function (scope, predicate, isRoot) {
    return $_gim1dr105jnlf47l0.ancestor(scope, predicate, isRoot).isSome();
  };
  var closest$1 = function (scope, predicate, isRoot) {
    return $_gim1dr105jnlf47l0.closest(scope, predicate, isRoot).isSome();
  };
  var sibling$1 = function (scope, predicate) {
    return $_gim1dr105jnlf47l0.sibling(scope, predicate).isSome();
  };
  var child$2 = function (scope, predicate) {
    return $_gim1dr105jnlf47l0.child(scope, predicate).isSome();
  };
  var descendant$1 = function (scope, predicate) {
    return $_gim1dr105jnlf47l0.descendant(scope, predicate).isSome();
  };
  var $_9kdlg3104jnlf47kz = {
    any: any$1,
    ancestor: ancestor$1,
    closest: closest$1,
    sibling: sibling$1,
  ...
  var hasFocus = function (element) {
    var doc = $_4on2xtypjnlf473t.owner(element).dom();
  ...
  var focusInside = function (element) {
    var doc = $_4on2xtypjnlf473t.owner(element);
    var inside = active(doc).filter(function (a) {
      return $_9kdlg3104jnlf47kz.closest(a, curry($_cyaumpyvjnlf4752.eq, element));
    });
  ...
  var search = function (element) {
    return active($_4on2xtypjnlf473t.owner(element)).filter(function (e) {
      return element.dom().contains(e.dom());
    });
  };
  var $_d478bi103jnlf47km = {
    hasFocus: hasFocus,
    focus: focus$2,
    blur: blur$$1,
    active: active,
  ...
  var $_em2mo0109jnlf47m8 = { openLink: openLink };
  ...
  var fromHtml$1 = function (html, scope) {
    ...
    var div = doc.createElement('div');
    div.innerHTML = html;
    return $_4on2xtypjnlf473t.children(Element$$1.fromDom(div));
  };
  ...
  var set$1 = function (element, content) {
    var owner = $_4on2xtypjnlf473t.owner(element);
    var docDom = owner.dom();
    var fragment = Element$$1.fromDom(docDom.createDocumentFragment());
    var contentElements = $_7ul0on10ijnlf47oc.fromHtml(content, docDom);
    $_4zppfzz2jnlf476k.append(fragment, contentElements);
    $_181c7wz1jnlf476d.empty(element);
    $_8lnrdpyojnlf473r.append(element, fragment);
  };
  var getOuter = function (element) {
    var container = Element$$1.fromTag('div');
    var clone = Element$$1.fromDom(element.dom().cloneNode(true));
    $_8lnrdpyojnlf473r.append(container, clone);
    return get$3(container);
  };
  var $_4j3j2510hjnlf47ob = {
    get: get$3,
    set: set$1,
    getOuter: getOuter
  };
  ...
  var shallowAs = function (original, tag) {
    ...
    var attributes = $_2u3dwzyjnlf47ja.clone(original);
    $_2u3dwzyjnlf47ja.setAll(nu, attributes);
    return nu;
  };
  var copy = function (original, tag) {
    var nu = shallowAs(original, tag);
    var cloneChildren = $_4on2xtypjnlf473t.children(deep$1(original));
    $_4zppfzz2jnlf476k.append(nu, cloneChildren);
    return nu;
  };
  var mutate = function (original, tag) {
    var nu = shallowAs(original, tag);
    $_8lnrdpyojnlf473r.before(original, nu);
    var children = $_4on2xtypjnlf473t.children(original);
    $_4zppfzz2jnlf476k.append(nu, children);
    $_181c7wz1jnlf476d.remove(original);
    return nu;
  };
  var $_8eg41c10jjnlf47ol = {
    shallow: shallow$1,
    shallowAs: shallowAs,
    deep: deep$1,
    copy: copy,
  ...
  var getHtml = function (element) {
    var clone = $_8eg41c10jjnlf47ol.shallow(element);
    return $_4j3j2510hjnlf47ob.getOuter(clone);
  };
  ...
  var toggle$2 = function (component, toggleConfig, toggleState) {
    $_4fn1o3zwjnlf47j8.toggle(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var on = function (component, toggleConfig, toggleState) {
    $_4fn1o3zwjnlf47j8.add(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var off = function (component, toggleConfig, toggleState) {
    $_4fn1o3zwjnlf47j8.remove(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var isOn = function (component, toggleConfig) {
    return $_4fn1o3zwjnlf47j8.has(component.element(), toggleConfig.toggleClass());
  };
  ...
  var updatePressed = function (component, ariaInfo, status) {
    $_2u3dwzyjnlf47ja.set(component.element(), 'aria-pressed', status);
    if (ariaInfo.syncWithExpanded()) {
      updateExpanded(component, ariaInfo, status);
    }
  };
  var updateSelected = function (component, ariaInfo, status) {
    $_2u3dwzyjnlf47ja.set(component.element(), 'aria-selected', status);
  };
  var updateChecked = function (component, ariaInfo, status) {
    $_2u3dwzyjnlf47ja.set(component.element(), 'aria-checked', status);
  };
  var updateExpanded = function (component, ariaInfo, status) {
    $_2u3dwzyjnlf47ja.set(component.element(), 'aria-expanded', status);
  };
  ...
  var format = function (command, update) {
    return Receiving.config({
      channels: wrap$2($_2kjzi110bjnlf47md.formatChanged(), {
  ...
  var orientation = function (onReceive) {
    return Receiving.config({ channels: wrap$2($_2kjzi110bjnlf47md.orientationChanged(), { onReceive: onReceive }) });
  };
  ...
  var events$2 = function (optAction) {
    ...
    var pointerEvents = $_fzox1py5jnlf46zr.detect().deviceType.isTouch() ? [run(tap(), onClick)] : [
      run(click(), onClick),
  ...
  var focus$3 = function (component, focusConfig) {
    if (!focusConfig.ignore()) {
      $_d478bi103jnlf47km.focus(component.element());
      focusConfig.onFocus()(component);
    }
  };
  var blur$1 = function (component, focusConfig) {
    if (!focusConfig.ignore()) {
      $_d478bi103jnlf47km.blur(component.element());
    }
  };
  var isFocused = function (component) {
    return $_d478bi103jnlf47km.hasFocus(component.element());
  };
  ...
  var $_434nrl119jnlf47zo = { isSupported: isSupported };
  ...
  var internalSet = function (dom, property, value) {
    ...
    if ($_434nrl119jnlf47zo.isSupported(dom))
  ...
  var get$4 = function (element, property) {
    ...
    var v = r === '' && !$_49tkmtykjnlf4732.inBody(element) ? getUnsafeProperty(dom, property) : r;
    return v === null ? undefined : v;
  };
  var getUnsafeProperty = function (dom, property) {
    return $_434nrl119jnlf47zo.isSupported(dom) ? dom.style.getPropertyValue(property) : '';
  };
  ...
  var remove$5 = function (element, property) {
    ...
    if ($_2u3dwzyjnlf47ja.has(element, 'style') && trim($_2u3dwzyjnlf47ja.get(element, 'style')) === '') {
      $_2u3dwzyjnlf47ja.remove(element, 'style');
    }
  };
  var preserve = function (element, f) {
    var oldStyles = $_2u3dwzyjnlf47ja.get(element, 'style');
    var result = f(element);
    var restore = oldStyles === undefined ? $_2u3dwzyjnlf47ja.remove : $_2u3dwzyjnlf47ja.set;
  ...
  var copy$1 = function (source, target) {
    ...
    if ($_434nrl119jnlf47zo.isSupported(sourceDom) && $_434nrl119jnlf47zo.isSupported(targetDom)) {
  ...
  function Dimension (name, getOffset) {
    ...
    var get = function (element) {
      ...
      if (r <= 0 || r === null) {
        var css = $_cva6ll118jnlf47yu.get(element, name);
    ...
    var aggregate = function (element, properties) {
      return foldl(properties, function (acc, property) {
        var val = $_cva6ll118jnlf47yu.get(element, property);
  ...
  var api = Dimension('height', function (element) {
    var dom = element.dom();
    return $_49tkmtykjnlf4732.inBody(element) ? dom.getBoundingClientRect().height : dom.offsetHeight;
  });
  ...
  var setMax = function (element, value) {
    ...
    $_cva6ll118jnlf47yu.set(element, 'max-height', absMax + 'px');
  };
  var $_8dbbnl117jnlf47yt = {
    set: set$3,
    get: get$5,
    getOuter: getOuter$1,
    setMax: setMax
  ...
  var all$2 = function (predicate) {
    return descendants($_49tkmtykjnlf4732.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_4on2xtypjnlf473t.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_4on2xtypjnlf473t.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_4on2xtypjnlf473t.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each$1($_4on2xtypjnlf473t.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$3 = function (selector) {
    return $_2zt1o6z0jnlf475z.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_4zoxsl11cjnlf4807.ancestors(scope, function (e) {
      return $_2zt1o6z0jnlf475z.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_4zoxsl11cjnlf4807.siblings(scope, function (e) {
      return $_2zt1o6z0jnlf475z.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_4zoxsl11cjnlf4807.children(scope, function (e) {
      return $_2zt1o6z0jnlf475z.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_2zt1o6z0jnlf475z.all(selector, scope);
  };
  var $_cnghgg11bjnlf4806 = {
    all: all$3,
  ...
  var first$2 = function (selector) {
    return $_2zt1o6z0jnlf475z.one(selector);
  };
  var ancestor$2 = function (scope, selector, isRoot) {
    return $_gim1dr105jnlf47l0.ancestor(scope, function (e) {
      return $_2zt1o6z0jnlf475z.is(e, selector);
    }, isRoot);
  };
  var sibling$2 = function (scope, selector) {
    return $_gim1dr105jnlf47l0.sibling(scope, function (e) {
      return $_2zt1o6z0jnlf475z.is(e, selector);
    });
  };
  var child$3 = function (scope, selector) {
    return $_gim1dr105jnlf47l0.child(scope, function (e) {
      return $_2zt1o6z0jnlf475z.is(e, selector);
    });
  };
  var descendant$2 = function (scope, selector) {
    return $_2zt1o6z0jnlf475z.one(selector, scope);
  };
  var closest$2 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_2zt1o6z0jnlf475z.is, ancestor$2, scope, selector, isRoot);
  };
  var $_g6pm3w11djnlf480e = {
    first: first$2,
    ancestor: ancestor$2,
    sibling: sibling$2,
    child: child$3,
  ...
  var dehighlightAll = function (component, hConfig, hState) {
    var highlighted = $_cnghgg11bjnlf4806.descendants(component.element(), '.' + hConfig.highlightClass());
    each$1(highlighted, function (h) {
      $_4fn1o3zwjnlf47j8.remove(h, hConfig.highlightClass());
  ...
  var dehighlight = function (component, hConfig, hState, target) {
    ...
    $_4fn1o3zwjnlf47j8.remove(target.element(), hConfig.highlightClass());
    if (wasHighlighted) {
      hConfig.onDehighlight()(component, target);
    }
  };
  var highlight = function (component, hConfig, hState, target) {
    ...
    $_4fn1o3zwjnlf47j8.add(target.element(), hConfig.highlightClass());
    if (!wasHighlighted) {
  ...
  var highlightBy = function (component, hConfig, hState, predicate) {
    var items = $_cnghgg11bjnlf4806.descendants(component.element(), '.' + hConfig.itemClass());
  ...
  var isHighlighted = function (component, hConfig, hState, queryTarget) {
    return $_4fn1o3zwjnlf47j8.has(queryTarget.element(), hConfig.highlightClass());
  };
  var getHighlighted = function (component, hConfig, hState) {
    return $_g6pm3w11djnlf480e.descendant(component.element(), '.' + hConfig.highlightClass()).bind(function (e) {
  ...
  var getFirst = function (component, hConfig, hState) {
    return $_g6pm3w11djnlf480e.descendant(component.element(), '.' + hConfig.itemClass()).bind(function (e) {
      return component.getSystem().getByDom(e).toOption();
    });
  };
  ...
  var getDelta = function (component, hConfig, hState, delta) {
    ...
    var current = findIndex(items, function (item) {
      return $_4fn1o3zwjnlf47j8.has(item, hConfig.highlightClass());
    });
  ...
  var dom = function () {
    var get = function (component) {
      return $_d478bi103jnlf47km.search(component.element());
    };
  ...
  var create$2 = function (cyclicField) {
    ...
    var isVisible = function (tabbingConfig, element) {
      var target = tabbingConfig.visibilitySelector().bind(function (sel) {
        return $_g6pm3w11djnlf480e.closest(element, sel);
      }).getOr(element);
      return $_8dbbnl117jnlf47yt.get(target) > 0;
    };
    var findInitial = function (component, tabbingConfig) {
      var tabstops = $_cnghgg11bjnlf4806.descendants(component.element(), tabbingConfig.selector());
    ...
    var findCurrent = function (component, tabbingConfig) {
      return tabbingConfig.focusManager().get(component).bind(function (elem) {
        return $_g6pm3w11djnlf480e.closest(elem, tabbingConfig.selector());
      });
    };
    ...
    var go = function (component, simulatedEvent, tabbingConfig, cycle) {
      ...
      return findCurrent(component, tabbingConfig).bind(function (tabstop) {
        var optStopIndex = findIndex(tabstops, curry($_cyaumpyvjnlf4752.eq, tabstop));
  ...
  var inside = function (target) {
    return $_40epr8ymjnlf473o.name(target) === 'input' && $_2u3dwzyjnlf47ja.get(target, 'type') !== 'radio' || $_40epr8ymjnlf473o.name(target) === 'textarea';
  };
  ...
  var getDirection = function (element) {
    return $_cva6ll118jnlf47yu.get(element, 'direction') === 'rtl' ? 'rtl' : 'ltr';
  };
  var $_8rcr9u11vjnlf486k = {
  ...
  var west = function (moveLeft, moveRight) {
    var movement = $_8rcr9u11vjnlf486k.onDirection(moveLeft, moveRight);
    return useH(movement);
  };
  var east = function (moveLeft, moveRight) {
    var movement = $_8rcr9u11vjnlf486k.onDirection(moveRight, moveLeft);
    return useH(movement);
  };
  ...
  var visibilityToggler = function (element, property, hiddenValue, visibleValue) {
    var initial = $_cva6ll118jnlf47yu.get(element, property);
    if (initial === undefined)
      initial = '';
    var value = initial === hiddenValue ? visibleValue : hiddenValue;
    var off = curry($_cva6ll118jnlf47yu.set, element, property, initial);
    var on = curry($_cva6ll118jnlf47yu.set, element, property, value);
  ...
  var locateVisible = function (container, current, selector) {
    var filter$$1 = $_7ng57811xjnlf487d.isVisible;
    return locateIn(container, current, selector, filter$$1);
  };
  var locateIn = function (container, current, selector, filter$$1) {
    var predicate = curry($_cyaumpyvjnlf4752.eq, current);
    var candidates = $_cnghgg11bjnlf4806.descendants(container, selector);
    var visible = filter(candidates, $_7ng57811xjnlf487d.isVisible);
    return locate(visible, predicate);
  };
  var findIndex$2 = function (elements, target) {
    return findIndex(elements, function (elem) {
      return $_cyaumpyvjnlf4752.eq(target, elem);
    });
  };
  ...
  var focusIn = function (component, gridConfig, gridState) {
    $_g6pm3w11djnlf480e.descendant(component.element(), gridConfig.selector()).each(function (first) {
      gridConfig.focusManager().set(component, first);
    });
  };
  var findCurrent = function (component, gridConfig) {
    return gridConfig.focusManager().get(component).bind(function (elem) {
      return $_g6pm3w11djnlf480e.closest(elem, gridConfig.selector());
    });
  };
  ...
  var findCurrent$1 = function (component, flowConfig) {
    return flowConfig.focusManager().get(component).bind(function (elem) {
      return $_g6pm3w11djnlf480e.closest(elem, flowConfig.selector());
    });
  };
  ...
  var focusIn$1 = function (component, flowConfig) {
    flowConfig.getInitial()(component).or($_g6pm3w11djnlf480e.descendant(component.element(), flowConfig.selector())).each(function (first) {
  ...
  var focusIn$2 = function (component, matrixConfig) {
    var focused = matrixConfig.previousSelector()(component).orThunk(function () {
      ...
      return $_g6pm3w11djnlf480e.descendant(component.element(), selectors.cell());
    });
  ...
  var execute$4 = function (component, simulatedEvent, matrixConfig) {
    return $_d478bi103jnlf47km.search(component.element()).bind(function (focused) {
      return matrixConfig.execute()(component, simulatedEvent, focused);
    });
  };
  var toMatrix = function (rows, matrixConfig) {
    return map$1(rows, function (row) {
      return $_cnghgg11bjnlf4806.descendants(row, matrixConfig.selectors().cell());
    });
  };
  var doMove$2 = function (ifCycle, ifMove) {
    return function (element, focused, matrixConfig) {
      var move$$1 = matrixConfig.cycles() ? ifCycle : ifMove;
      return $_g6pm3w11djnlf480e.closest(focused, matrixConfig.selectors().row()).bind(function (inRow) {
        var cellsInRow = $_cnghgg11bjnlf4806.descendants(inRow, matrixConfig.selectors().cell());
        return findIndex$2(cellsInRow, focused).bind(function (colIndex) {
          var allRows = $_cnghgg11bjnlf4806.descendants(element, matrixConfig.selectors().row());
  ...
  var focusIn$3 = function (component, menuConfig) {
    $_g6pm3w11djnlf480e.descendant(component.element(), menuConfig.selector()).each(function (first) {
  ...
  var subPlaceholder = function (owner, detail, compSpec, placeholders) {
    ...
    return readOptFrom$1(placeholders, compSpec.name).fold(function () {
      throw new Error('Unknown placeholder component: ' + compSpec.name + '\nKnown: [' + keys(placeholders) + ']\nNamespace: ' + owner.getOr('none') + '\nSpec: ' + $_776w81zjjnlf47cr.stringify(compSpec, null, 2));
    }, function (newSpec) {
  ...
  var substitutePlaces = function (owner, detail, components, placeholders) {
    ...
    each(ps, function (p) {
      if (p.used() === false && p.required()) {
        throw new Error('Placeholder: ' + p.name() + ' was not found in components list\nNamespace: ' + owner.getOr('none') + '\nComponents: ' + $_776w81zjjnlf47cr.stringify(detail.components(), null, 2));
      }
    });
    return outcome;
  };
  ...
  var write = function (label, elem) {
    ...
    $_2u3dwzyjnlf47ja.set(elem, idAttr$1, id);
    return id;
  };
  var writeOnly = function (elem, uid) {
    $_2u3dwzyjnlf47ja.set(elem, idAttr$1, uid);
  };
  var read$2 = function (elem) {
    var id = $_40epr8ymjnlf473o.isElement(elem) ? $_2u3dwzyjnlf47ja.get(elem, idAttr$1) : null;
  ...
  var fromHtml$2 = function (html) {
    ...
    var children = $_4on2xtypjnlf473t.children(elem);
    var attrs = getAttrs(elem);
    var classes = getClasses(elem);
    var contents = children.length === 0 ? {} : { innerHtml: $_4j3j2510hjnlf47ob.get(elem) };
    return deepMerge({
      tag: $_40epr8ymjnlf473o.name(elem),
      classes: classes,
      attributes: attrs
    }, contents);
  };
  ...
  var dom$1 = function (rawHtml) {
    var html = supplant(rawHtml, { prefix: $_bymmbj10vjnlf47uf.prefix() });
  ...
  var getToggleBehaviours = function (command) {
    return derive$2([
      Toggling.config({
        toggleClass: $_bymmbj10vjnlf47uf.resolve('toolbar-button-selected'),
        toggleOnExecute: false,
        aria: { mode: 'pressed' }
      }),
      $_dryfed10ujnlf47u6.format(command, function (button, status) {
  ...
  var isTouch = $_fzox1py5jnlf46zr.detect().deviceType.isTouch();
  ...
  var platform = $_fzox1py5jnlf46zr.detect();
  ...
  var isTouch$2 = $_fzox1py5jnlf46zr.detect().deviceType.isTouch();
  var SliderSchema = [
    strict$1('min'),
    strict$1('max'),
  ...
  var setMax$1 = function (element, value) {
    ...
    $_cva6ll118jnlf47yu.set(element, 'max-width', absMax + 'px');
  };
  var $_7uh968132jnlf48u5 = {
    set: set$4,
    get: get$7,
    getOuter: getOuter$2,
    setMax: setMax$1
  ...
  var isTouch$3 = $_fzox1py5jnlf46zr.detect().deviceType.isTouch();
  var sketch$1 = function (detail, components$$1, spec, externals) {
    ...
    var refresh = function (component) {
      ...
      var thumbRadius = $_7uh968132jnlf48u5.get(thumb.element()) / 2;
      $_cva6ll118jnlf47yu.set(thumb.element(), 'left', pos - thumbRadius + 'px');
    };
    var changeValue = function (component, newValue) {
      var oldValue = detail.value().get();
      var thumb = getThumb(component);
      if (oldValue !== newValue || $_cva6ll118jnlf47yu.getRaw(thumb.element(), 'left').isNone()) {
  ...
  var button = function (realm, clazz, makeItems) {
    return $_69unxb10wjnlf47uk.forToolbar(clazz, function () {
      var items = makeItems();
  ...
  var makeSlider = function (spec$$1) {
    ...
    var onInit = function (slider, thumb, value) {
      ...
      $_cva6ll118jnlf47yu.set(thumb.element(), 'background-color', color);
    };
    ...
    return Slider.sketch({
      ...
      components: [
        ...
        Slider.parts().spectrum({
          ...
          behaviours: derive$2([Toggling.config({ toggleClass: $_bymmbj10vjnlf47uf.resolve('thumb-active') })])
        }),
      ...
      sliderBehaviours: derive$2([$_dryfed10ujnlf47u6.orientation(Slider.refresh)])
    });
  };
  ...
  var sketch$3 = function (rawSpec) {
    ...
    return Slider.sketch({
      dom: {
        tag: 'div',
        classes: [
          $_bymmbj10vjnlf47uf.resolve('slider-' + spec$$1.category + '-size-container'),
          $_bymmbj10vjnlf47uf.resolve('slider'),
          $_bymmbj10vjnlf47uf.resolve('slider-size-container')
        ]
      },
      onChange: onChange,
      onDragStart: function (slider, thumb) {
  ...
  var $_1e8ib1135jnlf48ud = { sketch: sketch$3 };
  ...
  var getRawOrComputed = function (isRoot, rawStart) {
    var optStart = $_40epr8ymjnlf473o.isElement(rawStart) ? Option.some(rawStart) : $_4on2xtypjnlf473t.parent(rawStart);
    return optStart.map(function (start) {
      var inline = $_gim1dr105jnlf47l0.closest(start, function (elem) {
        return $_cva6ll118jnlf47yu.getRaw(elem, 'font-size').isSome();
      }, isRoot).bind(function (elem) {
        return $_cva6ll118jnlf47yu.getRaw(elem, 'font-size');
      });
      return inline.getOrThunk(function () {
        return $_cva6ll118jnlf47yu.get(start, 'font-size');
      });
    }).getOr('');
  };
  var getSize = function (editor) {
    ...
    var isRoot = function (e) {
      return $_cyaumpyvjnlf4752.eq(root, e);
    };
  ...
  var $_bwf7x8136jnlf48v4 = {
    candidates: constant(candidates),
    get: get$8,
    apply: apply$1
  };

  var sizes = $_bwf7x8136jnlf48v4.candidates();
  var makeSlider$1 = function (spec$$1) {
    return $_1e8ib1135jnlf48ud.sketch({
  ...
  var sketch$4 = function (realm, editor) {
    var spec$$1 = {
      onChange: function (value) {
        $_bwf7x8136jnlf48v4.apply(editor, value);
      },
      getInitialValue: function () {
        return $_bwf7x8136jnlf48v4.get(editor);
      }
    };
  ...
  function Blob (parts, properties) {
    var f = $_18n9jdyxjnlf475q.getOrDie('Blob');
    return new f(parts, properties);
  }

  function FileReader () {
    var f = $_18n9jdyxjnlf475q.getOrDie('FileReader');
    return new f();
  }

  function Uint8Array (arr) {
    var f = $_18n9jdyxjnlf475q.getOrDie('Uint8Array');
    return new f(arr);
  }

  var requestAnimationFrame = function (callback) {
    var f = $_18n9jdyxjnlf475q.getOrDie('requestAnimationFrame');
    f(callback);
  };
  var atob = function (base64) {
    var f = $_18n9jdyxjnlf475q.getOrDie('atob');
    return f(base64);
  };
  var $_ezs7l313hjnlf48z6 = {
    atob: atob,
  ...
  function dataUriToBlobSync(uri) {
    ...
    var base64 = data[1];
    var sliceSize = 1024;
    var byteCharacters = $_ezs7l313hjnlf48z6.atob(base64);
  ...
  function blobToCanvas(blob) {
    return blobToImage(blob).then(function (image) {
      ...
      var context, canvas;
      canvas = $_fj9br913bjnlf48yw.create($_cswp9y13cjnlf48yx.getWidth(image), $_cswp9y13cjnlf48yx.getHeight(image));
      context = $_fj9br913bjnlf48yw.get2dContext(canvas);
  ...
  var blobToImage$1 = function (image) {
    return $_ea7ps713ajnlf48y0.blobToImage(image);
  };
  var imageToBlob$1 = function (blob) {
    return $_ea7ps713ajnlf48y0.imageToBlob(blob);
  };
  var blobToDataUri$1 = function (blob) {
    return $_ea7ps713ajnlf48y0.blobToDataUri(blob);
  };
  var blobToBase64$1 = function (blob) {
    return $_ea7ps713ajnlf48y0.blobToBase64(blob);
  };
  var dataUriToBlobSync$1 = function (uri) {
    return $_ea7ps713ajnlf48y0.dataUriToBlobSync(uri);
  };
  var uriToBlob$1 = function (uri) {
    return Option.from($_ea7ps713ajnlf48y0.uriToBlob(uri));
  };
  var $_18e3ui139jnlf48xs = {
  ...
  var addImage = function (editor, blob) {
    $_18e3ui139jnlf48xs.blobToBase64(blob).then(function (base64) {
      editor.undoManager.transact(function () {
  ...
  var fromLink = function (link) {
    var text = $_ekhes213kjnlf490g.get(link);
    var url = $_2u3dwzyjnlf47ja.get(link, 'href');
    var title = $_2u3dwzyjnlf47ja.get(link, 'title');
    var target = $_2u3dwzyjnlf47ja.get(link, 'target');
    return {
  ...
  var wasSimple = function (link) {
    var prevHref = $_2u3dwzyjnlf47ja.get(link, 'href');
    var prevText = $_ekhes213kjnlf490g.get(link);
  ...
  var applyInfo = function (editor, info) {
    info.url.filter(isNotEmpty).fold(function () {
      ...
      activeLink.fold(function () {
        ...
        $_2u3dwzyjnlf47ja.setAll(link, attrs);
        text.each(function (newText) {
          $_ekhes213kjnlf490g.set(link, newText);
        });
      });
    });
  };
  var query = function (editor) {
    ...
    return $_g6pm3w11djnlf480e.closest(start, 'a');
  };
  var $_813yp513jjnlf48zn = {
    getInfo: getInfo,
    applyInfo: applyInfo,
    query: query
  };

  var platform$1 = $_fzox1py5jnlf46zr.detect();
  ...
  var $_bwlxiv13ljnlf490h = { forAndroid: forAndroid };
  ...
  var focusBehaviours = function (detail) {
    return derive$2([Focusing.config({
        onFocus: detail.selectOnFocus() === false ? noop : function (component) {
          ...
          var value = $_80c6ez13vjnlf4959.get(input);
    ...
    return deepMerge(derive$2([Representing.config({
        store: {
          ...
          getValue: function (input) {
            return $_80c6ez13vjnlf4959.get(input.element());
          },
          setValue: function (input, data) {
            var current = $_80c6ez13vjnlf4959.get(input.element());
            if (current !== data) {
              $_80c6ez13vjnlf4959.set(input.element(), data);
            }
          }
        },
    ...
    return {
      ...
      spec: Container.sketch({
        ...
        containerBehaviours: derive$2([
          Toggling.config({ toggleClass: $_bymmbj10vjnlf47uf.resolve('input-container-empty') }),
          Composing.config({
            find: function (comp) {
  ...
  var hasNative = function (component) {
    return contains(nativeDisabled, $_40epr8ymjnlf473o.name(component.element()));
  };
  var nativeIsDisabled = function (component) {
    return $_2u3dwzyjnlf47ja.has(component.element(), 'disabled');
  };
  var nativeDisable = function (component) {
    $_2u3dwzyjnlf47ja.set(component.element(), 'disabled', 'disabled');
  };
  var nativeEnable = function (component) {
    $_2u3dwzyjnlf47ja.remove(component.element(), 'disabled');
  };
  var ariaIsDisabled = function (component) {
    return $_2u3dwzyjnlf47ja.get(component.element(), 'aria-disabled') === 'true';
  };
  var ariaDisable = function (component) {
    $_2u3dwzyjnlf47ja.set(component.element(), 'aria-disabled', 'true');
  };
  var ariaEnable = function (component) {
    $_2u3dwzyjnlf47ja.set(component.element(), 'aria-disabled', 'false');
  };
  var disable = function (component, disableConfig, disableState) {
    disableConfig.disableClass().each(function (disableClass) {
      $_4fn1o3zwjnlf47j8.add(component.element(), disableClass);
    });
  ...
  var enable = function (component, disableConfig, disableState) {
    disableConfig.disableClass().each(function (disableClass) {
      $_4fn1o3zwjnlf47j8.remove(component.element(), disableClass);
    });
  ...
  var sketch$7 = function (rawSpec) {
    ...
    var navigationButton = function (direction, directionName, enabled) {
      return Button.sketch({
        ...
        buttonBehaviours: derive$2([Disabling.config({
            disableClass: $_bymmbj10vjnlf47uf.resolve('toolbar-navigation-disabled'),
            disabled: !enabled
          })])
      });
    };
    var reposition = function (dialog, message) {
      $_g6pm3w11djnlf480e.descendant(dialog.element(), '.' + $_bymmbj10vjnlf47uf.resolve('serialised-dialog-chain')).each(function (parent) {
        $_cva6ll118jnlf47yu.set(parent, 'left', -spec$$1.state.currentScreen.get() * message.width + 'px');
      });
    };
    var navigate = function (dialog, direction) {
      var screens = $_cnghgg11bjnlf4806.descendants(dialog.element(), '.' + $_bymmbj10vjnlf47uf.resolve('serialised-dialog-screen'));
      $_g6pm3w11djnlf480e.descendant(dialog.element(), '.' + $_bymmbj10vjnlf47uf.resolve('serialised-dialog-chain')).each(function (parent) {
        if (spec$$1.state.currentScreen.get() + direction >= 0 && spec$$1.state.currentScreen.get() + direction < screens.length) {
          $_cva6ll118jnlf47yu.getRaw(parent, 'left').each(function (left) {
            var currentLeft = parseInt(left, 10);
            var w = $_7uh968132jnlf48u5.get(screens[0]);
            $_cva6ll118jnlf47yu.set(parent, 'left', currentLeft - direction * w + 'px');
          });
    ...
    var focusInput = function (dialog) {
      var inputs = $_cnghgg11bjnlf4806.descendants(dialog.element(), 'input');
    ...
    var memForm = record(Form.sketch(function (parts) {
      return {
        ...
        formBehaviours: derive$2([
          $_dryfed10ujnlf47u6.orientation(function (dialog, message) {
    ...
    var memDots = record({
      ...
      behaviours: derive$2([Highlighting.config({
          highlightClass: $_bymmbj10vjnlf47uf.resolve('dot-active'),
          itemClass: $_bymmbj10vjnlf47uf.resolve('dot-item')
        })]),
      ...
      behaviours: derive$2([
        ...
        config(wrapperAdhocEvents, [
          run(touchstart(), function (wrapper, simulatedEvent) {
            var event = simulatedEvent.event();
            spec$$1.state.dialogSwipeState.set($_ndmfj146jnlf49aq.init(event.touches[0].clientX));
          }),
          run(touchmove(), function (wrapper, simulatedEvent) {
            var event = simulatedEvent.event();
            spec$$1.state.dialogSwipeState.on(function (state) {
              simulatedEvent.event().prevent();
              spec$$1.state.dialogSwipeState.set($_ndmfj146jnlf49aq.move(state, event.raw().touches[0].clientX));
            });
          }),
          run(touchend(), function (wrapper) {
            spec$$1.state.dialogSwipeState.on(function (state) {
              var dialog = memForm.get(wrapper);
              var direction = -1 * $_ndmfj146jnlf49aq.complete(state);
              navigate(dialog, direction);
            });
          })
        ])
  ...
  var getGroups = cached(function (realm, editor) {
    return [{
        ...
        items: [sketch$7({
            ...
            getInitialValue: function () {
              return Option.some($_813yp513jjnlf48zn.getInfo(editor));
            },
            onExecute: function (dialog) {
              var info = Representing.getValue(dialog);
              $_813yp513jjnlf48zn.applyInfo(editor, info);
  ...
  var sketch$8 = function (realm, editor) {
    return $_69unxb10wjnlf47uk.forToolbarStateAction(editor, 'link', 'link', function () {
      var groups = getGroups(realm, editor);
      realm.setContextToolbar(groups);
      $_bwlxiv13ljnlf490h.forAndroid(editor, function () {
        realm.focusToolbar();
      });
      $_813yp513jjnlf48zn.query(editor).each(function (link) {
  ...
  var isRecursive = function (component, originator, target) {
    return $_cyaumpyvjnlf4752.eq(originator, component.element()) && !$_cyaumpyvjnlf4752.eq(originator, target);
  };
  ...
  var generateFrom = function (spec, all) {
    ...
    var validated = asStruct('component.behaviours', objOf(schema), spec.behaviours).fold(function (errInfo) {
      throw new Error(formatError(errInfo) + '\nComplete spec:\n' + $_776w81zjjnlf47cr.stringify(spec, null, 2));
    }, function (v) {
      return v;
    });
    return {
  ...
  var onlyOne = function (chain, aspect) {
    if (chain.length > 1) {
      return Result.error('Multiple behaviours have tried to change DOM "' + aspect + '". The guilty behaviours are: ' + $_776w81zjjnlf47cr.stringify(map$1(chain, function (b) {
        return b.name();
  ...
  var duplicate = function (aspect, k, obj, behaviours) {
    return Result.error('Mulitple behaviours have tried to change the _' + k + '_ "' + aspect + '"' + '. The guilty behaviours are: ' + $_776w81zjjnlf47cr.stringify(bind(behaviours, function (b) {
  ...
  var sortKeys = function (label, keyName, array, order) {
    ...
    try {
      var sorted = sliced.sort(function (a, b) {
        ...
        if (aIndex === -1) {
          throw new Error('The ordering for ' + label + ' does not have an entry for ' + aKey + '.\nOrder specified: ' + $_776w81zjjnlf47cr.stringify(order, null, 2));
        }
        if (bIndex === -1) {
  ...
  var missingOrderError = function (eventName, tuples) {
    return Result.error(['The event (' + eventName + ') has more than one behaviour that listens to it.\nWhen this occurs, you must ' + 'specify an event ordering for the behaviours in your spec (e.g. [ "listing", "toggling" ]).\nThe behaviours that ' + 'can trigger it are: ' + $_776w81zjjnlf47cr.stringify(map$1(tuples, function (c) {
        return c.name();
      }), null, 2)]);
  };
  ...
  var add$3 = function (element, classes) {
    each$1(classes, function (x) {
      $_4fn1o3zwjnlf47j8.add(element, x);
    });
  };
  var remove$6 = function (element, classes) {
    each$1(classes, function (x) {
      $_4fn1o3zwjnlf47j8.remove(element, x);
    });
  };
  var toggle$3 = function (element, classes) {
    each$1(classes, function (x) {
      $_4fn1o3zwjnlf47j8.toggle(element, x);
    });
  };
  var hasAll = function (element, classes) {
    return forall(classes, function (clazz) {
      return $_4fn1o3zwjnlf47j8.has(element, clazz);
    });
  };
  ...
  var get$11 = function (element) {
    return $_6eyngwzzjnlf47jt.supports(element) ? getNative(element) : $_6eyngwzzjnlf47jt.get(element);
  };
  var $_4lrhkg14ojnlf49pz = {
    add: add$3,
    remove: remove$6,
    toggle: toggle$3,
    hasAll: hasAll,
  ...
  var renderToDom = function (definition) {
    ...
    $_2u3dwzyjnlf47ja.setAll(subject, definition.attributes().getOr({}));
    $_4lrhkg14ojnlf49pz.add(subject, definition.classes().getOr([]));
    $_cva6ll118jnlf47yu.setAll(subject, definition.styles().getOr({}));
    $_4j3j2510hjnlf47ob.set(subject, definition.innerHtml().getOr(''));
    var children = getChildren(definition);
    $_4zppfzz2jnlf476k.append(subject, children);
    definition.value().each(function (value) {
      $_80c6ez13vjnlf4959.set(subject, value);
    });
    return subject;
  };
  ...
  var build = function (spec) {
    ...
    var syncComponents = function () {
      var children = $_4on2xtypjnlf473t.children(item);
    ...
    var config = function (behaviour) {
      ...
      var f = isFunction(b[behaviour.name()]) ? b[behaviour.name()] : function () {
        throw new Error('Could not find ' + behaviour.name() + ' in ' + $_776w81zjjnlf47cr.stringify(spec, null, 2));
      };
      return f();
    };
  ...
  var onHover = function (item) {
    if ($_d478bi103jnlf47km.search(item.element()).isNone() || Focusing.isFocused(item)) {
  ...
  var preserve$2 = function (f, container) {
    var ownerDoc = $_4on2xtypjnlf473t.owner(container);
    var refocus = $_d478bi103jnlf47km.active(ownerDoc).bind(function (focused) {
      var hasFocus = function (elem) {
        return $_cyaumpyvjnlf4752.eq(focused, elem);
      };
      return hasFocus(container) ? Option.some(container) : $_gim1dr105jnlf47l0.descendant(container, hasFocus);
    });
    var result = f(container);
    refocus.each(function (oldFocus) {
      $_d478bi103jnlf47km.active(ownerDoc).filter(function (newFocus) {
        return $_cyaumpyvjnlf4752.eq(newFocus, oldFocus);
      }).fold(function () {
        $_d478bi103jnlf47km.focus(oldFocus);
      }, noop);
    });
    return result;
  };
  ...
  var append$2 = function (component, replaceConfig, replaceState, appendee) {
    insert(component, replaceConfig, $_8lnrdpyojnlf473r.append, appendee);
  };
  var prepend$2 = function (component, replaceConfig, replaceState, prependee) {
    insert(component, replaceConfig, $_8lnrdpyojnlf473r.prepend, prependee);
  };
  var remove$7 = function (component, replaceConfig, replaceState, removee) {
    var children = contents(component, replaceConfig);
    var foundChild = find$2(children, function (child) {
      return $_cyaumpyvjnlf4752.eq(removee.element(), child.element());
    });
  ...
  var make$3 = function (detail, rawUiSpec) {
    ...
    var updateMenuPath = function (container, state, path) {
      return Option.from(path[0]).bind(state.lookupMenu).map(function (activeMenu) {
        ...
        each$1(rest, function (r) {
          $_4fn1o3zwjnlf47j8.add(r.element(), detail.markers().backgroundMenu());
        });
        if (!$_49tkmtykjnlf4732.inBody(activeMenu.element())) {
          Replacing.append(container, premade$1(activeMenu));
        }
        $_4lrhkg14ojnlf49pz.remove(activeMenu.element(), [detail.markers().backgroundMenu()]);
        setActiveMenu(container, activeMenu);
        var others = getMenus(state, state.otherMenus(path));
        each$1(others, function (o) {
          $_4lrhkg14ojnlf49pz.remove(o.element(), [detail.markers().backgroundMenu()]);
          if (!detail.stayInDom()) {
    ...
    var keyOnItem = function (f) {
      return function (container, simulatedEvent) {
        return $_g6pm3w11djnlf480e.closest(simulatedEvent.getSource(), '.' + detail.markers().item()).bind(function (target) {
  ...
  var disableTransition = function (comp, transConfig, transState) {
    getTransition(comp, transConfig, transState).each(function (routeTransition) {
      ...
      $_4fn1o3zwjnlf47j8.remove(comp.element(), t.transitionClass());
      $_2u3dwzyjnlf47ja.remove(comp.element(), transConfig.destinationAttr());
    });
  };
  var getNewRoute = function (comp, transConfig, transState, destination) {
    return {
      start: constant($_2u3dwzyjnlf47ja.get(comp.element(), transConfig.stateAttr())),
      destination: constant(destination)
    };
  };
  var getCurrentRoute = function (comp, transConfig, transState) {
    var el = comp.element();
    return $_2u3dwzyjnlf47ja.has(el, transConfig.destinationAttr()) ? Option.some({
      start: constant($_2u3dwzyjnlf47ja.get(comp.element(), transConfig.stateAttr())),
      destination: constant($_2u3dwzyjnlf47ja.get(comp.element(), transConfig.destinationAttr()))
    }) : Option.none();
  };
  var jumpTo = function (comp, transConfig, transState, destination) {
    disableTransition(comp, transConfig, transState);
    if ($_2u3dwzyjnlf47ja.has(comp.element(), transConfig.stateAttr()) && $_2u3dwzyjnlf47ja.get(comp.element(), transConfig.stateAttr()) !== destination) {
      transConfig.onFinish()(comp, destination);
    }
    $_2u3dwzyjnlf47ja.set(comp.element(), transConfig.stateAttr(), destination);
  };
  var fasttrack = function (comp, transConfig, transState, destination) {
    if ($_2u3dwzyjnlf47ja.has(comp.element(), transConfig.destinationAttr())) {
      $_2u3dwzyjnlf47ja.set(comp.element(), transConfig.stateAttr(), $_2u3dwzyjnlf47ja.get(comp.element(), transConfig.destinationAttr()));
      $_2u3dwzyjnlf47ja.remove(comp.element(), transConfig.destinationAttr());
    }
  };
  var progressTo = function (comp, transConfig, transState, destination) {
    ...
    getTransitionOf(comp, transConfig, transState, route).fold(function () {
      ...
      disableTransition(comp, transConfig, transState);
      var t = routeTransition.transition();
      $_4fn1o3zwjnlf47j8.add(comp.element(), t.transitionClass());
      $_2u3dwzyjnlf47ja.set(comp.element(), transConfig.destinationAttr(), destination);
    });
  };
  var getState = function (comp, transConfig, transState) {
    var e = comp.element();
    return $_2u3dwzyjnlf47ja.has(e, transConfig.stateAttr()) ? Option.some($_2u3dwzyjnlf47ja.get(e, transConfig.stateAttr())) : Option.none();
  };
  ...
  var scrollable = $_bymmbj10vjnlf47uf.resolve('scrollable');
  var register = function (element) {
    $_4fn1o3zwjnlf47j8.add(element, scrollable);
  };
  var deregister = function (element) {
    $_4fn1o3zwjnlf47j8.remove(element, scrollable);
  };
  var $_8ni6dd15bjnlf4a2j = {
    register: register,
  ...
  var makeItem = function (value, text$$1, selected, preview, isMenu) {
    return {
      ...
      dom: {
        tag: 'div',
        classes: isMenu ? [$_bymmbj10vjnlf47uf.resolve('styles-item-is-menu')] : []
      },
      toggling: {
        toggleOnExecute: false,
        toggleClass: $_bymmbj10vjnlf47uf.resolve('format-matches'),
        selected: selected
      },
      itemBehaviours: derive$2(isMenu ? [] : [$_dryfed10ujnlf47u6.format(value, function (comp, status) {
          var toggle = status ? Toggling.on : Toggling.off;
          toggle(comp);
        })]),
      components: [{
    ...
    return {
      ...
      components: [
        Button.sketch({
          dom: {
            tag: 'div',
            classes: [$_bymmbj10vjnlf47uf.resolve('styles-collapser')]
          },
          components: collapsable ? [
            {
              dom: {
                tag: 'span',
                classes: [$_bymmbj10vjnlf47uf.resolve('styles-collapse-icon')]
              }
            },
            text(value)
          ] : [text(value)],
        ...
        }),
        {
          dom: {
            tag: 'div',
            classes: [$_bymmbj10vjnlf47uf.resolve('styles-menu-items-container')]
          },
          components: [Menu.parts().items({})],
          behaviours: derive$2([config('adhoc-scrollable-menu', [
              runOnAttached(function (component, simulatedEvent) {
                $_cva6ll118jnlf47yu.set(component.element(), 'overflow-y', 'auto');
                $_cva6ll118jnlf47yu.set(component.element(), '-webkit-overflow-scrolling', 'touch');
                $_8ni6dd15bjnlf4a2j.register(component.element());
              }),
              runOnDetached(function (component) {
                $_cva6ll118jnlf47yu.remove(component.element(), 'overflow-y');
                $_cva6ll118jnlf47yu.remove(component.element(), '-webkit-overflow-scrolling');
                $_8ni6dd15bjnlf4a2j.deregister(component.element());
              })
            ])])
        }
      ],
  ...
  var sketch$9 = function (settings) {
    ...
    var memMenu = record(tieredMenu.sketch({
      dom: {
        tag: 'div',
        classes: [$_bymmbj10vjnlf47uf.resolve('styles-menu')]
      },
      components: [],
      fakeFocus: true,
      stayInDom: true,
      ...
      onOpenMenu: function (container, menu) {
        var w = $_7uh968132jnlf48u5.get(container.element());
        $_7uh968132jnlf48u5.set(menu.element(), w);
        Transitioning.jumpTo(menu, 'current');
      },
      onOpenSubmenu: function (container, item, submenu) {
        var w = $_7uh968132jnlf48u5.get(container.element());
        var menu = $_g6pm3w11djnlf480e.ancestor(item.element(), '[role="menu"]').getOrDie('hacky');
        var menuComp = container.getSystem().getByDom(menu).getOrDie();
        $_7uh968132jnlf48u5.set(submenu.element(), w);
        Transitioning.progressTo(menuComp, 'before');
        Transitioning.jumpTo(submenu, 'after');
        Transitioning.progressTo(submenu, 'current');
      },
      onCollapseMenu: function (container, item, menu) {
        var submenu = $_g6pm3w11djnlf480e.ancestor(item.element(), '[role="menu"]').getOrDie('hacky');
      ...
      data: dataset.tmenu,
      markers: {
        backgroundMenu: $_bymmbj10vjnlf47uf.resolve('styles-background-menu'),
        menu: $_bymmbj10vjnlf47uf.resolve('styles-menu'),
        selectedMenu: $_bymmbj10vjnlf47uf.resolve('styles-selected-menu'),
        item: $_bymmbj10vjnlf47uf.resolve('styles-item'),
        selectedItem: $_bymmbj10vjnlf47uf.resolve('styles-selected-item')
      }
    }));
    return memMenu.asSpec();
  };
  var $_4vsefo149jnlf49c0 = { sketch: sketch$9 };
  ...
  var $_3ce30i15cjnlf4a2t = { expand: expand };
  ...
  var prune = function (editor, formats) {
    ...
    return $_3ce30i15cjnlf4a2t.expand(prunedItems);
  };
  var ui = function (editor, formats, onDone) {
    var pruned = prune(editor, formats);
    return $_4vsefo149jnlf49c0.sketch({
      formats: pruned,
  ...
  var setup = function (realm, editor) {
    var commandSketch = function (name) {
      return function () {
        return $_69unxb10wjnlf47uk.forToolbarCommand(editor, name);
      };
    };
    var stateCommandSketch = function (name) {
      return function () {
        return $_69unxb10wjnlf47uk.forToolbarStateCommand(editor, name);
      };
    };
    var actionSketch = function (name, query, action) {
      return function () {
        return $_69unxb10wjnlf47uk.forToolbarStateAction(editor, name, query, action);
      };
    };
    ...
    var forecolor = function () {
      return $_e68iec12mjnlf48nj.sketch(realm, editor);
    };
    var styleFormats = $_5tnhsx147jnlf49as.register(editor, editor.settings);
    var styleFormatsMenu = function () {
      return $_5tnhsx147jnlf49as.ui(editor, styleFormats, function () {
        editor.fire('scrollIntoView');
      });
    };
    var styleselect = function () {
      return $_69unxb10wjnlf47uk.forToolbar('style-formats', function (button) {
        ...
        Receiving.config({
          channels: wrapAll$1([
            $_dryfed10ujnlf47u6.receive($_2kjzi110bjnlf47md.orientationChanged(), Toggling.off),
            $_dryfed10ujnlf47u6.receive($_2kjzi110bjnlf47md.dropupDismissed(), Toggling.off)
          ])
        })
      ]));
    };
  ...
  var bind$2 = function (element, event, handler) {
    return $_2pnkcm15fjnlf4a48.bind(element, event, filter$1, handler);
  };
  var capture$1 = function (element, event, handler) {
    return $_2pnkcm15fjnlf4a48.capture(element, event, filter$1, handler);
  };
  var $_a1t09t15ejnlf4a41 = {
    bind: bind$2,
    capture: capture$1
  };
  ...
  var getActualWidth = function (outerWindow) {
    var isIos = $_fzox1py5jnlf46zr.detect().os.isiOS();
  ...
  var onChange = function (outerWindow, listeners) {
    ...
    var orientationHandle = $_a1t09t15ejnlf4a41.bind(win, 'orientationchange', change);
  ...
  var monitor = function (settings) {
    ...
    var handleTouchend = function (event) {
      ...
      var isSame = function (data) {
        return $_cyaumpyvjnlf4752.eq(data.target(), event.target());
      };
  ...
  var monitor$1 = function (editorApi) {
    ...
    var onTouchend = function () {
      return $_a1t09t15ejnlf4a41.bind(editorApi.body(), 'touchend', function (evt) {
        tapEvent.fireIfReady(evt, 'touchend');
      });
    };
    var onTouchmove = function () {
      return $_a1t09t15ejnlf4a41.bind(editorApi.body(), 'touchmove', function (evt) {
  ...
  var $_3b578e15kjnlf4a78 = { monitor: monitor$1 };

  var isAndroid6 = $_fzox1py5jnlf46zr.detect().os.version.major >= 6;
  var initEvents = function (editorApi, toolstrip, alloy) {
    var tapping = $_3b578e15kjnlf4a78.monitor(editorApi);
    var outerDoc = $_4on2xtypjnlf473t.owner(toolstrip);
    var isRanged = function (sel) {
      return !$_cyaumpyvjnlf4752.eq(sel.start(), sel.finish()) || sel.soffset() !== sel.foffset();
    };
    var hasRangeInUi = function () {
      return $_d478bi103jnlf47km.active(outerDoc).filter(function (input) {
        return $_40epr8ymjnlf473o.name(input) === 'input';
    ...
    var listeners = [
      $_a1t09t15ejnlf4a41.bind(editorApi.body(), 'touchstart', function (evt) {
        editorApi.onTouchContent();
        tapping.fireTouchstart(evt);
      }),
      tapping.onTouchmove(),
      tapping.onTouchend(),
      $_a1t09t15ejnlf4a41.bind(toolstrip, 'touchstart', function (evt) {
        editorApi.onTouchToolstrip();
      }),
      editorApi.onToReading(function () {
        $_d478bi103jnlf47km.blur(editorApi.body());
      }),
      ...
      $_a1t09t15ejnlf4a41.bind(Element$$1.fromDom(editorApi.win()), 'blur', function () {
        alloy.getByDom(toolstrip).each(Toggling.off);
      }),
      $_a1t09t15ejnlf4a41.bind(outerDoc, 'select', updateMargin),
      $_a1t09t15ejnlf4a41.bind(editorApi.doc(), 'selectionchange', updateMargin)
    ]);
    var destroy = function () {
  ...
  var $_5cksup15jjnlf4a5t = { initEvents: initEvents };

  var safeParse = function (element, attribute) {
    var parsed = parseInt($_2u3dwzyjnlf47ja.get(element, attribute), 10);
    return isNaN(parsed) ? 0 : parsed;
  };
  var $_clbvgw15ojnlf4a93 = { safeParse: safeParse };
  ...
  var api$3 = NodeValue($_40epr8ymjnlf473o.isText, 'text');
  ...
  var getEnd = function (element) {
    return $_40epr8ymjnlf473o.name(element) === 'img' ? 1 : $_c1p2px15rjnlf4aa7.getOption(element).fold(function () {
      return $_4on2xtypjnlf473t.children(element).length;
    }, function (v) {
      return v.length;
    });
  };
  ...
  var isTextNodeWithCursorPosition = function (el) {
    return $_c1p2px15rjnlf4aa7.getOption(el).filter(function (text) {
  ...
  var isCursorPosition = function (elem) {
    ...
    return hasCursorPosition || contains(elementsWithCursorPosition, $_40epr8ymjnlf473o.name(elem));
  };
  var $_60td2615qjnlf4aa1 = {
    getEnd: getEnd,
    isEnd: isEnd,
    isStart: isStart,
  ...
  var getStart$1 = function (selection) {
    return selection.match({
      ...
      relative: function (startSitu, finishSitu) {
        return $_32zg0h15ujnlf4ab0.getStart(startSitu);
      },
  ...
  var getWin = function (selection) {
    ...
    return $_4on2xtypjnlf473t.defaultView(start);
  };
  var $_ewu49f15tjnlf4aal = {
  ...
  var makeRange = function (start, soffset, finish, foffset) {
    var doc = $_4on2xtypjnlf473t.owner(start);
  ...
  var after$2 = function (start, soffset, finish, foffset) {
    var r = makeRange(start, soffset, finish, foffset);
    var same = $_cyaumpyvjnlf4752.eq(start, finish) && soffset === foffset;
    return r.collapsed && !same;
  };
  var $_6rrhfv15wjnlf4abl = {
    after: after$2,
  ...
  var $_ejw1q615xjnlf4abm = { fromElements: fromElements };
  ...
  var getRanges = function (win, selection) {
    return selection.match({
      ...
      relative: function (startSitu, finishSitu) {
        return {
          ltr: cached(function () {
            return $_cg56vm15yjnlf4abx.relativeToNative(win, startSitu, finishSitu);
          }),
          rtl: cached(function () {
            return Option.some($_cg56vm15yjnlf4abx.relativeToNative(win, finishSitu, startSitu));
          })
        };
      },
      exact: function (start, soffset, finish, foffset) {
        return {
          ltr: cached(function () {
            return $_cg56vm15yjnlf4abx.exactToNative(win, start, soffset, finish, foffset);
          }),
          rtl: cached(function () {
            return Option.some($_cg56vm15yjnlf4abx.exactToNative(win, finish, foffset, start, soffset));
          })
        };
      }
    });
  ...
  var locateOffset = function (doc, textnode, x, y, rect) {
    ...
    var length = $_c1p2px15rjnlf4aa7.get(textnode).length;
    var offset = $_g4jdxy162jnlf4adn.searchForPoint(rectForOffset, x, y, rect.right, length);
  ...
  var locate$1 = function (doc, node, x, y) {
    ...
    var foundRect = findMap(rects, function (rect) {
      return $_g4jdxy162jnlf4adn.inRect(rect, x, y) ? Option.some(rect) : Option.none();
    });
    return foundRect.map(function (rect) {
      return locateOffset(doc, node, x, y, rect);
    });
  };
  var $_bcnzfk163jnlf4ado = { locate: locate$1 };

  var searchInChildren = function (doc, node, x, y) {
    var r = doc.dom().createRange();
    var nodes = $_4on2xtypjnlf473t.children(node);
    return findMap(nodes, function (n) {
      r.selectNode(n.dom());
      return $_g4jdxy162jnlf4adn.inRect(r.getBoundingClientRect(), x, y) ? locateNode(doc, n, x, y) : Option.none();
    });
  };
  var locateNode = function (doc, node, x, y) {
    var locator = $_40epr8ymjnlf473o.isText(node) ? $_bcnzfk163jnlf4ado.locate : searchInChildren;
  ...
  var $_36ouou161jnlf4ad7 = { locate: locate$2 };

  var first$3 = function (element) {
    return $_gim1dr105jnlf47l0.descendant(element, $_60td2615qjnlf4aa1.isCursorPosition);
  };
  var last$2 = function (element) {
    return descendantRtl(element, $_60td2615qjnlf4aa1.isCursorPosition);
  };
  var descendantRtl = function (scope, predicate) {
    var descend = function (element) {
      var children = $_4on2xtypjnlf473t.children(element);
  ...
  var locateInElement = function (doc, node, x) {
    ...
    var f = collapseDirection === COLLAPSE_TO_LEFT ? $_8ddpnu165jnlf4aea.first : $_8ddpnu165jnlf4aea.last;
  ...
  var search$1 = function (doc, node, x) {
    var f = $_4on2xtypjnlf473t.children(node).length === 0 ? locateInEmpty : locateInElement;
    return f(doc, node, x);
  };
  var $_4vu1mj164jnlf4ae3 = { search: search$1 };
  ...
  var searchTextNodes = function (doc, node, x, y) {
    ...
    var boundedX = Math.max(rect.left, Math.min(rect.right, x));
    var boundedY = Math.max(rect.top, Math.min(rect.bottom, y));
    return $_36ouou161jnlf4ad7.locate(doc, node, boundedX, boundedY);
  };
  var searchFromPoint = function (doc, x, y) {
    return Element$$1.fromPoint(doc, x, y).bind(function (elem) {
      var fallback = function () {
        return $_4vu1mj164jnlf4ae3.search(doc, elem, x);
      };
      return $_4on2xtypjnlf473t.children(elem).length === 0 ? fallback() : searchTextNodes(doc, elem, x, y).orThunk(fallback);
    });
  };
  ...
  var fromPoint$1 = function (win, x, y) {
    ...
    return availableSearch(doc, x, y).map(function (rng) {
      return $_ewu49f15tjnlf4aal.range(Element$$1.fromDom(rng.startContainer), rng.startOffset, Element$$1.fromDom(rng.endContainer), rng.endOffset);
    });
  };
  var $_4cjyjp160jnlf4ad0 = { fromPoint: fromPoint$1 };

  var withinContainer = function (win, ancestor, outerRange, selector) {
    var innerRange = $_cg56vm15yjnlf4abx.create(win);
    var self = $_2zt1o6z0jnlf475z.is(ancestor, selector) ? [ancestor] : [];
    var elements = self.concat($_cnghgg11bjnlf4806.descendants(ancestor, selector));
    return filter(elements, function (elem) {
      $_cg56vm15yjnlf4abx.selectNodeContentsUsing(innerRange, elem);
      return $_cg56vm15yjnlf4abx.isWithin(outerRange, innerRange);
    });
  };
  var find$3 = function (win, selection, selector) {
    var outerRange = $_5ptol415zjnlf4acb.asLtrRange(win, selection);
    var ancestor = Element$$1.fromDom(outerRange.commonAncestorContainer);
    return $_40epr8ymjnlf473o.isElement(ancestor) ? withinContainer(win, ancestor, outerRange, selector) : [];
  };
  var $_7zfz9d166jnlf4aeg = { find: find$3 };

  var beforeSpecial = function (element, offset) {
    var name = $_40epr8ymjnlf473o.name(element);
    if ('input' === name)
      return $_32zg0h15ujnlf4ab0.after(element);
    else if (!contains([
        'br',
        'img'
      ], name))
      return $_32zg0h15ujnlf4ab0.on(element, offset);
    else
      return offset === 0 ? $_32zg0h15ujnlf4ab0.before(element) : $_32zg0h15ujnlf4ab0.after(element);
  };
  var preprocessRelative = function (startSitu, finishSitu) {
    var start = startSitu.fold($_32zg0h15ujnlf4ab0.before, beforeSpecial, $_32zg0h15ujnlf4ab0.after);
    var finish = finishSitu.fold($_32zg0h15ujnlf4ab0.before, beforeSpecial, $_32zg0h15ujnlf4ab0.after);
    return $_ewu49f15tjnlf4aal.relative(start, finish);
  };
  var preprocessExact = function (start, soffset, finish, foffset) {
    var startSitu = beforeSpecial(start, soffset);
    var finishSitu = beforeSpecial(finish, foffset);
    return $_ewu49f15tjnlf4aal.relative(startSitu, finishSitu);
  };
  ...
  var doSetRange = function (win, start, soffset, finish, foffset) {
    var rng = $_cg56vm15yjnlf4abx.exactToNative(win, start, soffset, finish, foffset);
    doSetNativeRange(win, rng);
  };
  var findWithin = function (win, selection, selector) {
    return $_7zfz9d166jnlf4aeg.find(win, selection, selector);
  };
  ...
  var setRangeFromRelative = function (win, relative) {
    return $_5ptol415zjnlf4acb.diagnose(win, relative).match({
      ltr: function (start, soffset, finish, foffset) {
  ...
  var setExact = function (win, start, soffset, finish, foffset) {
    var relative = $_3rqj9o167jnlf4aeu.preprocessExact(start, soffset, finish, foffset);
    setRangeFromRelative(win, relative);
  };
  var setRelative = function (win, startSitu, finishSitu) {
    var relative = $_3rqj9o167jnlf4aeu.preprocessRelative(startSitu, finishSitu);
    setRangeFromRelative(win, relative);
  };
  var toNative = function (selection) {
    var win = $_ewu49f15tjnlf4aal.getWin(selection).dom();
    var getDomRange = function (start, soffset, finish, foffset) {
      return $_cg56vm15yjnlf4abx.exactToNative(win, start, soffset, finish, foffset);
    };
    var filtered = $_3rqj9o167jnlf4aeu.preprocess(selection);
    return $_5ptol415zjnlf4acb.diagnose(win, filtered).match({
      ltr: getDomRange,
      rtl: getDomRange
    });
  };
  var readRange = function (selection) {
    if (selection.rangeCount > 0) {
      ...
      return Option.some($_ewu49f15tjnlf4aal.range(Element$$1.fromDom(firstRng.startContainer), firstRng.startOffset, Element$$1.fromDom(lastRng.endContainer), lastRng.endOffset));
    } else {
      return Option.none();
    }
  };
  var doGetExact = function (selection) {
    ...
    return $_6rrhfv15wjnlf4abl.after(anchorNode, selection.anchorOffset, focusNode, selection.focusOffset) ? Option.some($_ewu49f15tjnlf4aal.range(Element$$1.fromDom(selection.anchorNode), selection.anchorOffset, Element$$1.fromDom(selection.focusNode), selection.focusOffset)) : readRange(selection);
  };
  var setToElement = function (win, element) {
    var rng = $_cg56vm15yjnlf4abx.selectNodeContents(win, element);
    doSetNativeRange(win, rng);
  };
  ...
  var get$14 = function (win) {
    return getExact(win).map(function (range) {
      return $_ewu49f15tjnlf4aal.exact(range.start(), range.soffset(), range.finish(), range.foffset());
    });
  };
  var getFirstRect$1 = function (win, selection) {
    var rng = $_5ptol415zjnlf4acb.asLtrRange(win, selection);
    return $_cg56vm15yjnlf4abx.getFirstRect(rng);
  };
  var getBounds$1 = function (win, selection) {
    var rng = $_5ptol415zjnlf4acb.asLtrRange(win, selection);
    return $_cg56vm15yjnlf4abx.getBounds(rng);
  };
  var getAtPoint = function (win, x, y) {
    return $_4cjyjp160jnlf4ad0.fromPoint(win, x, y);
  };
  var getAsString = function (win, selection) {
    var rng = $_5ptol415zjnlf4acb.asLtrRange(win, selection);
    return $_cg56vm15yjnlf4abx.toString(rng);
  };
  ...
  var clone$3 = function (win, selection) {
    var rng = $_5ptol415zjnlf4acb.asLtrRange(win, selection);
    return $_cg56vm15yjnlf4abx.cloneFragment(rng);
  };
  var replace = function (win, selection, elements) {
    var rng = $_5ptol415zjnlf4acb.asLtrRange(win, selection);
    var fragment = $_ejw1q615xjnlf4abm.fromElements(elements, win.document);
    $_cg56vm15yjnlf4abx.replaceWith(rng, fragment);
  };
  var deleteAt = function (win, selection) {
    var rng = $_5ptol415zjnlf4acb.asLtrRange(win, selection);
    $_cg56vm15yjnlf4abx.deleteContents(rng);
  };
  var isCollapsed = function (start, soffset, finish, foffset) {
    return $_cyaumpyvjnlf4752.eq(start, finish) && soffset === foffset;
  };
  var $_gcx46215vjnlf4abc = {
    setExact: setExact,
    getExact: getExact,
    get: get$14,
  ...
  var getRectsFromRange = function (range$$1) {
    if (!range$$1.collapsed) {
      ...
      return $_4on2xtypjnlf473t.parent(start_1).bind(function (parent) {
        var selection = $_ewu49f15tjnlf4aal.exact(start_1, range$$1.startOffset, parent, $_60td2615qjnlf4aa1.getEnd(parent));
        var optRect = $_gcx46215vjnlf4abc.getFirstRect(range$$1.startContainer.ownerDocument.defaultView, selection);
  ...
  var $_ep62vm15pjnlf4a98 = { getRectangles: getRectangles };
  ...
  var resume = function (cWin) {
    ...
    var inInput = $_d478bi103jnlf47km.active().exists(function (elem) {
      return contains([
        'input',
        'textarea'
      ], $_40epr8ymjnlf473o.name(elem));
    });
    var transaction = inInput ? autocompleteHack() : apply;
    transaction(function () {
      $_d478bi103jnlf47km.active().each($_d478bi103jnlf47km.blur);
      $_d478bi103jnlf47km.focus(iBody);
    });
  };
  var $_b474be168jnlf4af6 = { resume: resume };

  var EXTRA_SPACING = 50;
  var data = 'data-' + $_bymmbj10vjnlf47uf.resolve('last-outer-height');
  var setLastHeight = function (cBody, value) {
    $_2u3dwzyjnlf47ja.set(cBody, data, value);
  };
  var getLastHeight = function (cBody) {
    return $_clbvgw15ojnlf4a93.safeParse(cBody, data);
  };
  ...
  var getBounds$2 = function (cWin) {
    var rects = $_ep62vm15pjnlf4a98.getRectangles(cWin);
  ...
  var setup$1 = function (outerWindow, cWin) {
    ...
    var toEditing = function () {
      $_b474be168jnlf4af6.resume(cWin);
    };
    var onResize = $_a1t09t15ejnlf4a41.bind(Element$$1.fromDom(outerWindow), 'resize', function () {
  ...
  var $_293cne15njnlf4a8e = { setup: setup$1 };
  ...
  var getSelectionFromFrame = function (frame) {
    ...
    return optWin.bind($_gcx46215vjnlf4abc.getExact);
  };
  ...
  var getOrListen = function (editor, doc, name, type) {
    return editor[name].getOrThunk(function () {
      return function (handler) {
        return $_a1t09t15ejnlf4a41.bind(doc, type, handler);
      };
    });
  };
  ...
  var getActiveApi = function (editor) {
    ...
    var tryFallbackBox = function (win) {
      ...
      return $_gcx46215vjnlf4abc.getExact(win).filter(isCollapsed).bind(toStartRect);
    };
      ...
      return getDocFromFrame(frame).bind(function (doc) {
        return getWinFromFrame(frame).map(function (win) {
          ...
          var getCursorBox = editor.getCursorBox.getOrThunk(function () {
            return function () {
              return $_gcx46215vjnlf4abc.get(win).bind(function (sel) {
                return $_gcx46215vjnlf4abc.getFirstRect(win, sel).orThunk(function () {
          ...
          var setSelection = editor.setSelection.getOrThunk(function () {
            return function (start, soffset, finish, foffset) {
              $_gcx46215vjnlf4abc.setExact(win, start, soffset, finish, foffset);
            };
          });
          var clearSelection = editor.clearSelection.getOrThunk(function () {
            return function () {
              $_gcx46215vjnlf4abc.clear(win);
            };
          });
          return {
            body: constant(body),
  ...
  var isAndroid = $_fzox1py5jnlf46zr.detect().os.isAndroid();
  var matchColor = function (editorBody) {
    var color = $_cva6ll118jnlf47yu.get(editorBody, 'background-color');
    return color !== undefined && color !== '' ? 'background-color:' + color + '!important' : bgFallback;
  };
  var clobberStyles = function (container, editorBody) {
    var gatherSibilings = function (element) {
      var siblings = $_cnghgg11bjnlf4806.siblings(element, '*');
      return siblings;
    };
    var clobber = function (clobberStyle) {
      return function (element) {
        var styles = $_2u3dwzyjnlf47ja.get(element, 'style');
        var backup = styles === undefined ? 'no-styles' : styles.trim();
        if (backup === clobberStyle) {
          return;
        } else {
          $_2u3dwzyjnlf47ja.set(element, attr, backup);
          $_2u3dwzyjnlf47ja.set(element, 'style', clobberStyle);
        }
      };
    };
    var ancestors = $_cnghgg11bjnlf4806.ancestors(container, '*');
  ...
  var restoreStyles = function () {
    var clobberedEls = $_cnghgg11bjnlf4806.all('[' + attr + ']');
    each$1(clobberedEls, function (element) {
      var restore = $_2u3dwzyjnlf47ja.get(element, attr);
      if (restore !== 'no-styles') {
        $_2u3dwzyjnlf47ja.set(element, 'style', restore);
      } else {
        $_2u3dwzyjnlf47ja.remove(element, 'style');
      }
      $_2u3dwzyjnlf47ja.remove(element, attr);
  ...
  var $_a16ka216ajnlf4ahv = {
    clobberStyles: clobberStyles,
    restoreStyles: restoreStyles
  };

  var tag = function () {
    var head = $_g6pm3w11djnlf480e.first('head').getOrDie();
    var nu = function () {
      var meta = Element$$1.fromTag('meta');
      $_2u3dwzyjnlf47ja.set(meta, 'name', 'viewport');
      $_8lnrdpyojnlf473r.append(head, meta);
      return meta;
    };
    var element = $_g6pm3w11djnlf480e.first('meta[name="viewport"]').getOrThunk(nu);
    var backup = $_2u3dwzyjnlf47ja.get(element, 'content');
    var maximize = function () {
      $_2u3dwzyjnlf47ja.set(element, 'content', 'width=device-width, initial-scale=1.0, user-scalable=no, maximum-scale=1.0');
    };
    var restore = function () {
      if (backup !== undefined && backup !== null && backup.length > 0) {
        $_2u3dwzyjnlf47ja.set(element, 'content', backup);
      } else {
        $_2u3dwzyjnlf47ja.set(element, 'content', 'user-scalable=yes');
      }
    };
    return {
      maximize: maximize,
  ...
  var $_7bl26g16bjnlf4aif = { tag: tag };

  var create$5 = function (platform, mask) {
    var meta = $_7bl26g16bjnlf4aif.tag();
    var androidApi = api$2();
    var androidEvents = api$2();
    var enter = function () {
      mask.hide();
      $_4fn1o3zwjnlf47j8.add(platform.container, $_bymmbj10vjnlf47uf.resolve('fullscreen-maximized'));
      $_4fn1o3zwjnlf47j8.add(platform.container, $_bymmbj10vjnlf47uf.resolve('android-maximized'));
      meta.maximize();
      $_4fn1o3zwjnlf47j8.add(platform.body, $_bymmbj10vjnlf47uf.resolve('android-scroll-reload'));
      androidApi.set($_293cne15njnlf4a8e.setup(platform.win, $_6q8u39169jnlf4agg.getWin(platform.editor).getOrDie('no')));
      $_6q8u39169jnlf4agg.getActiveApi(platform.editor).each(function (editorApi) {
        $_a16ka216ajnlf4ahv.clobberStyles(platform.container, editorApi.body());
        androidEvents.set($_5cksup15jjnlf4a5t.initEvents(editorApi, platform.toolstrip, platform.alloy));
      });
    };
    var exit = function () {
      meta.restore();
      mask.show();
      $_4fn1o3zwjnlf47j8.remove(platform.container, $_bymmbj10vjnlf47uf.resolve('fullscreen-maximized'));
      $_4fn1o3zwjnlf47j8.remove(platform.container, $_bymmbj10vjnlf47uf.resolve('android-maximized'));
      $_a16ka216ajnlf4ahv.restoreStyles();
      $_4fn1o3zwjnlf47j8.remove(platform.body, $_bymmbj10vjnlf47uf.resolve('android-scroll-reload'));
      androidEvents.clear();
      androidApi.clear();
    };
    return {
  ...
  var $_rboj315ijnlf4a5h = { create: create$5 };
  ...
  var sketch$10 = function (onView, translate) {
    var memIcon = record(Container.sketch({
      ...
      containerBehaviours: derive$2([Toggling.config({
          toggleClass: $_bymmbj10vjnlf47uf.resolve('mask-tap-icon-selected'),
          toggleOnExecute: false
        })])
    }));
    ...
    return Container.sketch({
      ...
      components: [Container.sketch({
          ...
          components: [Button.sketch({
              ...
              buttonBehaviours: derive$2([Toggling.config({ toggleClass: $_bymmbj10vjnlf47uf.resolve('mask-tap-icon-selected') })])
            })]
        })]
    });
  };
  var $_7zm0yv16cjnlf4aiy = { sketch: sketch$10 };
  ...
  var MobileSchema = objOf([
    ...
    state$1('win', function (spec) {
      return $_4on2xtypjnlf473t.owner(spec.socket).dom().defaultView;
    }),
  ...
  var produce = function (raw) {
    ...
    $_cva6ll118jnlf47yu.set(mobile.toolstrip, 'width', '100%');
    var onTap = function () {
      mobile.setReadOnly(mobile.readOnlyOnInit());
      mode.enter();
    };
    var mask = build$1($_7zm0yv16cjnlf4aiy.sketch(onTap, mobile.translate));
    ...
    $_8lnrdpyojnlf473r.append(mobile.container, mask.element());
    var mode = $_rboj315ijnlf4a5h.create(mobile, maskApi);
    return {
  ...
  var $_b0ma6g15hjnlf4a4u = { produce: produce };
  ...
  var dataHorizontal = 'data-' + $_bymmbj10vjnlf47uf.resolve('horizontal-scroll');
  ...
  var markAsHorizontal = function (container) {
    $_2u3dwzyjnlf47ja.set(container, dataHorizontal, 'true');
  };
  var hasScroll = function (container) {
    return $_2u3dwzyjnlf47ja.get(container, dataHorizontal) === 'true' ? hasHorizontalScroll(container) : hasVerticalScroll(container);
  };
  var exclusive = function (scope, selector) {
    return $_a1t09t15ejnlf4a41.bind(scope, 'touchmove', function (event) {
      $_g6pm3w11djnlf480e.closest(event.target(), selector).filter(hasScroll).fold(function () {
        event.raw().preventDefault();
      }, noop);
    });
  };
  var $_d3vtzu16kjnlf4anh = {
    exclusive: exclusive,
  ...
  function ScrollingToolbar () {
    var makeGroup = function (gSpec) {
      ...
      return {
        ...
        tgroupBehaviours: derive$2([config('adhoc-scrollable-toolbar', gSpec.scrollable === true ? [runOnInit(function (component, simulatedEvent) {
              $_cva6ll118jnlf47yu.set(component.element(), 'overflow-x', 'auto');
              $_d3vtzu16kjnlf4anh.markAsHorizontal(component.element());
              $_8ni6dd15bjnlf4a2j.register(component.element());
            })] : [])]),
        components: [Container.sketch({ components: [ToolbarGroup.parts().items({})] })],
        markers: { itemClass: $_bymmbj10vjnlf47uf.resolve('toolbar-group-item') },
        items: gSpec.items
      };
    };
    var toolbar = build$1(Toolbar.sketch({
      ...
      toolbarBehaviours: derive$2([
        Toggling.config({
          toggleClass: $_bymmbj10vjnlf47uf.resolve('context-toolbar'),
          toggleOnExecute: false,
          aria: { mode: 'none' }
        }),
    ...
    var wrapper = build$1(Container.sketch({
      dom: { classes: [$_bymmbj10vjnlf47uf.resolve('toolstrip')] },
      components: [premade$1(toolbar)],
      containerBehaviours: derive$2([Toggling.config({
          toggleClass: $_bymmbj10vjnlf47uf.resolve('android-selection-context-toolbar'),
          toggleOnExecute: false
        })])
    }));
  ...
  var disableTransitions = function (component, slideConfig) {
    ...
    $_4lrhkg14ojnlf49pz.remove(root, [
      slideConfig.shrinkingClass(),
      slideConfig.growingClass()
    ]);
  };
  var setShrunk = function (component, slideConfig) {
    $_4fn1o3zwjnlf47j8.remove(component.element(), slideConfig.openClass());
    $_4fn1o3zwjnlf47j8.add(component.element(), slideConfig.closedClass());
    $_cva6ll118jnlf47yu.set(component.element(), getDimensionProperty(slideConfig), '0px');
    $_cva6ll118jnlf47yu.reflow(component.element());
  };
  ...
  var setGrown = function (component, slideConfig) {
    $_4fn1o3zwjnlf47j8.remove(component.element(), slideConfig.closedClass());
    $_4fn1o3zwjnlf47j8.add(component.element(), slideConfig.openClass());
    $_cva6ll118jnlf47yu.remove(component.element(), getDimensionProperty(slideConfig));
  };
  var doImmediateShrink = function (component, slideConfig, slideState) {
    slideState.setCollapsed();
    $_cva6ll118jnlf47yu.set(component.element(), getDimensionProperty(slideConfig), getDimension(slideConfig, component.element()));
    $_cva6ll118jnlf47yu.reflow(component.element());
  ...
  var doStartShrink = function (component, slideConfig, slideState) {
    ...
    $_cva6ll118jnlf47yu.reflow(component.element());
    var root = getAnimationRoot(component, slideConfig);
    $_4fn1o3zwjnlf47j8.add(root, slideConfig.shrinkingClass());
    setShrunk(component, slideConfig);
    slideConfig.onStartShrink()(component);
  };
  var doStartGrow = function (component, slideConfig, slideState) {
    ...
    var root = getAnimationRoot(component, slideConfig);
    $_4fn1o3zwjnlf47j8.add(root, slideConfig.growingClass());
    setGrown(component, slideConfig);
    $_cva6ll118jnlf47yu.set(component.element(), getDimensionProperty(slideConfig), fullSize);
  ...
  var isGrowing = function (component, slideConfig, slideState) {
    var root = getAnimationRoot(component, slideConfig);
    return $_4fn1o3zwjnlf47j8.has(root, slideConfig.growingClass()) === true;
  };
  var isShrinking = function (component, slideConfig, slideState) {
    var root = getAnimationRoot(component, slideConfig);
    return $_4fn1o3zwjnlf47j8.has(root, slideConfig.shrinkingClass()) === true;
  };
  ...
  var events$10 = function (slideConfig, slideState) {
    return derive([run(transitionend(), function (component, simulatedEvent) {
        ...
        if (raw.propertyName === slideConfig.dimension().property()) {
          disableTransitions(component, slideConfig);
          if (slideState.isExpanded()) {
            $_cva6ll118jnlf47yu.remove(component.element(), slideConfig.dimension().property());
          }
    ...
    strictOf('dimension', choose$1('property', {
      width: [
        ...
        output$1('getDimension', function (elem) {
          return $_7uh968132jnlf48u5.get(elem) + 'px';
        })
      ],
      height: [
        output$1('property', 'height'),
        output$1('getDimension', function (elem) {
          return $_8dbbnl117jnlf47yt.get(elem) + 'px';
        })
      ]
    }))
  ];
  ...
  var build$2 = function (refresh, scrollIntoView) {
    var dropup = build$1(Container.sketch({
      dom: {
        tag: 'div',
        classes: [$_bymmbj10vjnlf47uf.resolve('dropup')]
      },
      components: [],
      containerBehaviours: derive$2([
        Replacing.config({}),
        Sliding.config({
          closedClass: $_bymmbj10vjnlf47uf.resolve('dropup-closed'),
          openClass: $_bymmbj10vjnlf47uf.resolve('dropup-open'),
          shrinkingClass: $_bymmbj10vjnlf47uf.resolve('dropup-shrinking'),
          growingClass: $_bymmbj10vjnlf47uf.resolve('dropup-growing'),
        ...
        $_dryfed10ujnlf47u6.orientation(function (component, data) {
          disappear(noop);
        })
      ])
    }));
  ...
  var isDangerous = function (event$$1) {
    ...
    return keyEv.which === BACKSPACE()[0] && !contains([
      'input',
      'textarea'
    ], $_40epr8ymjnlf473o.name(event$$1.target()));
  };
  var isFirefox = $_fzox1py5jnlf46zr.detect().browser.isFirefox();
  ...
  var bindFocus = function (container, handler) {
    if (isFirefox) {
      return $_a1t09t15ejnlf4a41.capture(container, 'focus', handler);
    } else {
      return $_a1t09t15ejnlf4a41.bind(container, 'focusin', handler);
    }
  };
  var bindBlur = function (container, handler) {
    if (isFirefox) {
      return $_a1t09t15ejnlf4a41.capture(container, 'blur', handler);
    } else {
      return $_a1t09t15ejnlf4a41.bind(container, 'focusout', handler);
    }
  };
  var setup$2 = function (container, rawSettings) {
    var settings = asRawOrDie('Getting GUI events settings', settingsSchema, rawSettings);
    var pointerEvents = $_fzox1py5jnlf46zr.detect().deviceType.isTouch() ? [
      'touchstart',
      'touchmove',
      'touchend',
      'gesturestart'
    ...
    var simpleEvents = map$1(pointerEvents.concat([
      ...
      return $_a1t09t15ejnlf4a41.bind(container, type, function (event$$1) {
    ...
    var onKeydown = $_a1t09t15ejnlf4a41.bind(container, 'keydown', function (event$$1) {
    ...
    var defaultView = $_4on2xtypjnlf473t.defaultView(container);
    var onWindowScroll = $_a1t09t15ejnlf4a41.bind(defaultView, 'scroll', function (event$$1) {
  ...
  var doTriggerHandler = function (lookup, eventType, rawEvent, target, source, logger) {
    ...
    return handler.fold(function () {
      ...
      if (simulatedEvent.isStopped()) {
        ...
        return $_4on2xtypjnlf473t.parent(handlerInfo.element()).fold(function () {
  ...
  var closest$3 = function (target, transform, isRoot) {
    var delegate = $_gim1dr105jnlf47l0.closest(target, function (elem) {
  ...
  function Registry () {
    ...
    var failOnDuplicate = function (component, tagId) {
      ...
      if (conflict === component) {
        ...
        throw new Error('The tagId "' + tagId + '" is already used by: ' + element(conflict.element()) + '\nCannot use it for: ' + element(component.element()) + '\n' + 'The conflicting element is' + ($_49tkmtykjnlf4732.inBody(conflict.element()) ? ' ' : ' not ') + 'already in the DOM');
      }
    };
  ...
  var takeover = function (root) {
    var isAboveRoot = function (el) {
      return $_4on2xtypjnlf473t.parent(root.element()).fold(function () {
        return true;
      }, function (parent) {
        return $_cyaumpyvjnlf4752.eq(el, parent);
      });
    };
    ...
    var systemApi = SystemApi({
      ...
      triggerFocus: function (target, originator) {
        read$2(target).fold(function () {
          $_d478bi103jnlf47km.focus(target);
        }, function (_alloyId) {
    ...
    var addToWorld = function (component) {
      ...
      if (!$_40epr8ymjnlf473o.isText(component.element())) {
    ...
    var destroy = function () {
      domEvents.unbind();
      $_181c7wz1jnlf476d.remove(root.element());
    };
  ...
  var READ_ONLY_MODE_CLASS = constant($_bymmbj10vjnlf47uf.resolve('readonly-mode'));
  var EDIT_MODE_CLASS = constant($_bymmbj10vjnlf47uf.resolve('edit-mode'));
  function OuterContainer (spec) {
    var root = build$1(Container.sketch({
      dom: { classes: [$_bymmbj10vjnlf47uf.resolve('outer-container')].concat(spec.classes) },
  ...
  function AndroidRealm (scrollIntoView) {
    var alloy = OuterContainer({ classes: [$_bymmbj10vjnlf47uf.resolve('android-container')] });
    var toolbar = ScrollingToolbar();
    var webapp = api$2();
    var switchToEdit = $_3cbg2w16ljnlf4anz.makeEditSwitch(webapp);
    var socket = $_3cbg2w16ljnlf4anz.makeSocket();
    ...
    var init = function (spec) {
      webapp.set($_b0ma6g15hjnlf4a4u.produce(spec));
    };
    var exit = function () {
      webapp.run(function (w) {
        w.exit();
    ...
    var updateMode = function (readOnly) {
      $_3cbg2w16ljnlf4anz.updateMode(socket, switchToEdit, readOnly, alloy.root());
    };
    return {
  ...
  var input$1 = function (parent, operation) {
    ...
    $_cva6ll118jnlf47yu.setAll(input, {
      opacity: '0',
      position: 'absolute',
      top: '-1000px',
      left: '-1000px'
    });
    $_8lnrdpyojnlf473r.append(parent, input);
    $_d478bi103jnlf47km.focus(input);
    operation(input);
    $_181c7wz1jnlf476d.remove(input);
  };
  var $_7u38i8175jnlf4b0j = { input: input$1 };
  ...
  var $_fssy44177jnlf4b1j = {
    refreshInput: refreshInput,
    refresh: refresh
  };

  var resume$1 = function (cWin, frame) {
    $_d478bi103jnlf47km.active().each(function (active) {
      if (!$_cyaumpyvjnlf4752.eq(active, frame)) {
        $_d478bi103jnlf47km.blur(active);
      }
    });
    cWin.focus();
    $_d478bi103jnlf47km.focus(Element$$1.fromDom(cWin.document.body));
    $_fssy44177jnlf4b1j.refresh(cWin);
  };
  var $_8kmk2a176jnlf4b14 = { resume: resume$1 };

  var stubborn = function (outerBody, cWin, page, frame) {
    var toEditing = function () {
      $_8kmk2a176jnlf4b14.resume(cWin, frame);
    };
    var toReading = function () {
      $_7u38i8175jnlf4b0j.input(outerBody, $_d478bi103jnlf47km.blur);
    };
    var captureInput = $_a1t09t15ejnlf4a41.bind(page, 'keydown', function (evt) {
      if (!contains([
          'input',
          'textarea'
        ], $_40epr8ymjnlf473o.name(evt.target()))) {
        toEditing();
      }
    });
  ...
  var initEvents$1 = function (editorApi, iosApi, toolstrip, socket, dropup) {
    ...
    var reposition = function () {
      var toolbarHeight = $_8dbbnl117jnlf47yt.get(toolstrip);
      iosApi.run(function (api) {
    ...
    var listeners = [
      ...
      $_a1t09t15ejnlf4a41.bind(editorApi.doc(), 'touchend', function (touchEvent) {
        if ($_cyaumpyvjnlf4752.eq(editorApi.html(), touchEvent.target()) || $_cyaumpyvjnlf4752.eq(editorApi.body(), touchEvent.target())) {
        }
      }),
      $_a1t09t15ejnlf4a41.bind(toolstrip, 'transitionend', function (transitionEvent) {
        if (transitionEvent.raw().propertyName === 'height') {
          reposition();
        }
      }),
      $_a1t09t15ejnlf4a41.capture(toolstrip, 'touchstart', function (touchEvent) {
        saveSelectionFirst();
      ...
      tapping.onTouchmove(),
      tapping.onTouchend(),
      $_a1t09t15ejnlf4a41.bind(editorApi.body(), 'click', function (event) {
        event.kill();
      }),
      $_a1t09t15ejnlf4a41.bind(toolstrip, 'touchmove', function () {
  ...
  var $_4zgelk178jnlf4b1p = { initEvents: initEvents$1 };

  function FakeSelection (win, frame) {
    var doc = win.document;
    var container = Element$$1.fromTag('div');
    $_4fn1o3zwjnlf47j8.add(container, $_bymmbj10vjnlf47uf.resolve('unfocused-selections'));
    $_8lnrdpyojnlf473r.append(Element$$1.fromDom(doc.documentElement), container);
    var onTouch = $_a1t09t15ejnlf4a41.bind(container, 'touchstart', function (event) {
      event.prevent();
      $_8kmk2a176jnlf4b14.resume(win, frame);
      clear();
    });
    var make = function (rectangle) {
      var span = Element$$1.fromTag('span');
      $_4lrhkg14ojnlf49pz.add(span, [
        $_bymmbj10vjnlf47uf.resolve('layer-editor'),
        $_bymmbj10vjnlf47uf.resolve('unfocused-selection')
      ]);
      $_cva6ll118jnlf47yu.setAll(span, {
    ...
    var update = function () {
      clear();
      var rectangles = $_ep62vm15pjnlf4a98.getRectangles(win);
      var spans = map$1(rectangles, make);
      $_4zppfzz2jnlf476k.append(container, spans);
    };
    var clear = function () {
      $_181c7wz1jnlf476d.empty(container);
    };
    var destroy = function () {
      onTouch.unbind();
      $_181c7wz1jnlf476d.remove(container);
    };
    var isActive = function () {
      return $_4on2xtypjnlf473t.children(container).length > 0;
    };
    return {
      update: update,
      isActive: isActive,
  ...
  var $_c5cyjp17ijnlf4b7c = { findDevice: findDevice };

  var softKeyboardLimits = function (outerWindow) {
    return $_c5cyjp17ijnlf4b7c.findDevice(outerWindow.screen.width, outerWindow.screen.height);
  };
  var accountableKeyboardHeight = function (outerWindow) {
    var portrait = $_ahfhke15djnlf4a36.get(outerWindow).isPortrait();
  ...
  var getGreenzone = function (socket, dropup) {
    var outerWindow = $_4on2xtypjnlf473t.owner(socket).dom().defaultView;
    var viewportHeight = $_8dbbnl117jnlf47yt.get(socket) + $_8dbbnl117jnlf47yt.get(dropup);
  ...
  var updatePadding = function (contentBody, socket, dropup) {
    ...
    var deltaHeight = $_8dbbnl117jnlf47yt.get(socket) + $_8dbbnl117jnlf47yt.get(dropup) - greenzoneHeight;
    $_cva6ll118jnlf47yu.set(contentBody, 'padding-bottom', deltaHeight + 'px');
  };
  var $_6vtdeq17hjnlf4b6x = {
  ...
  var yFixedData = 'data-' + $_bymmbj10vjnlf47uf.resolve('position-y-fixed');
  var yFixedProperty = 'data-' + $_bymmbj10vjnlf47uf.resolve('y-property');
  var yScrollingData = 'data-' + $_bymmbj10vjnlf47uf.resolve('scrolling');
  var windowSizeData = 'data-' + $_bymmbj10vjnlf47uf.resolve('last-window-height');
  var getYFixedData = function (element) {
    return $_clbvgw15ojnlf4a93.safeParse(element, yFixedData);
  };
  var getYFixedProperty = function (element) {
    return $_2u3dwzyjnlf47ja.get(element, yFixedProperty);
  };
  var getLastWindowSize = function (element) {
    return $_clbvgw15ojnlf4a93.safeParse(element, windowSizeData);
  };
  ...
  var classify = function (element) {
    ...
    var classifier = $_2u3dwzyjnlf47ja.get(element, yScrollingData) === 'true' ? classifyScrolling : classifyFixed;
    return classifier(element, offsetY);
  };
  var findFixtures = function (container) {
    var candidates = $_cnghgg11bjnlf4806.descendants(container, '[' + yFixedData + ']');
    return map$1(candidates, classify);
  };
  var takeoverToolbar = function (toolbar) {
    var oldToolbarStyle = $_2u3dwzyjnlf47ja.get(toolbar, 'style');
    $_cva6ll118jnlf47yu.setAll(toolbar, {
      position: 'absolute',
      top: '0px'
    });
    $_2u3dwzyjnlf47ja.set(toolbar, yFixedData, '0px');
    $_2u3dwzyjnlf47ja.set(toolbar, yFixedProperty, 'top');
    var restore = function () {
      $_2u3dwzyjnlf47ja.set(toolbar, 'style', oldToolbarStyle || '');
      $_2u3dwzyjnlf47ja.remove(toolbar, yFixedData);
      $_2u3dwzyjnlf47ja.remove(toolbar, yFixedProperty);
    };
    return { restore: restore };
  };
  var takeoverViewport = function (toolbarHeight, height, viewport) {
    var oldViewportStyle = $_2u3dwzyjnlf47ja.get(viewport, 'style');
    $_8ni6dd15bjnlf4a2j.register(viewport);
    $_cva6ll118jnlf47yu.setAll(viewport, {
      position: 'absolute',
      height: height + 'px',
      width: '100%',
      top: toolbarHeight + 'px'
    });
    $_2u3dwzyjnlf47ja.set(viewport, yFixedData, toolbarHeight + 'px');
    $_2u3dwzyjnlf47ja.set(viewport, yScrollingData, 'true');
    $_2u3dwzyjnlf47ja.set(viewport, yFixedProperty, 'top');
    var restore = function () {
      $_8ni6dd15bjnlf4a2j.deregister(viewport);
      $_2u3dwzyjnlf47ja.set(viewport, 'style', oldViewportStyle || '');
      $_2u3dwzyjnlf47ja.remove(viewport, yFixedData);
      $_2u3dwzyjnlf47ja.remove(viewport, yScrollingData);
      $_2u3dwzyjnlf47ja.remove(viewport, yFixedProperty);
    };
    return { restore: restore };
  };
  var takeoverDropup = function (dropup, toolbarHeight, viewportHeight) {
    var oldDropupStyle = $_2u3dwzyjnlf47ja.get(dropup, 'style');
    $_cva6ll118jnlf47yu.setAll(dropup, {
      position: 'absolute',
      bottom: '0px'
    });
    $_2u3dwzyjnlf47ja.set(dropup, yFixedData, '0px');
    $_2u3dwzyjnlf47ja.set(dropup, yFixedProperty, 'bottom');
    var restore = function () {
      $_2u3dwzyjnlf47ja.set(dropup, 'style', oldDropupStyle || '');
      $_2u3dwzyjnlf47ja.remove(dropup, yFixedData);
      $_2u3dwzyjnlf47ja.remove(dropup, yFixedProperty);
    };
    return { restore: restore };
  };
  var deriveViewportHeight = function (viewport, toolbarHeight, dropupHeight) {
    var outerWindow = $_4on2xtypjnlf473t.owner(viewport).dom().defaultView;
    var winH = outerWindow.innerHeight;
    $_2u3dwzyjnlf47ja.set(viewport, windowSizeData, winH + 'px');
    return winH - toolbarHeight - dropupHeight;
  };
  var takeover$1 = function (viewport, contentBody, toolbar, dropup) {
    var outerWindow = $_4on2xtypjnlf473t.owner(viewport).dom().defaultView;
    var toolbarSetup = takeoverToolbar(toolbar);
    var toolbarHeight = $_8dbbnl117jnlf47yt.get(toolbar);
    var dropupHeight = $_8dbbnl117jnlf47yt.get(dropup);
    ...
    var refresh = function () {
      if (isActive) {
        var newToolbarHeight = $_8dbbnl117jnlf47yt.get(toolbar);
        var dropupHeight_1 = $_8dbbnl117jnlf47yt.get(dropup);
        var newHeight = deriveViewportHeight(viewport, newToolbarHeight, dropupHeight_1);
        $_2u3dwzyjnlf47ja.set(viewport, yFixedData, newToolbarHeight + 'px');
        $_cva6ll118jnlf47yu.set(viewport, 'height', newHeight + 'px');
        $_cva6ll118jnlf47yu.set(dropup, 'bottom', -(newToolbarHeight + newHeight + dropupHeight_1) + 'px');
        $_6vtdeq17hjnlf4b6x.updatePadding(contentBody, viewport, dropup);
      }
    };
    var setViewportOffset = function (newYOffset) {
      var offsetPx = newYOffset + 'px';
      $_2u3dwzyjnlf47ja.set(viewport, yFixedData, offsetPx);
      refresh();
    };
    $_6vtdeq17hjnlf4b6x.updatePadding(contentBody, viewport, dropup);
    return {
  ...
  var $_1rv28317gjnlf4b5w = {
    findFixtures: findFixtures,
    takeover: takeover$1,
    getYFixedData: getYFixedData
  };

  var animator = $_e4pi8d17fjnlf4b5q.create();
  var ANIMATION_STEP = 15;
  var NUM_TOP_ANIMATION_FRAMES = 10;
  var ANIMATION_RATE = 10;
  var lastScroll = 'data-' + $_bymmbj10vjnlf47uf.resolve('last-scroll-top');
  var getTop = function (element) {
    var raw = $_cva6ll118jnlf47yu.getRaw(element, 'top').getOr('0');
  ...
  var moveScrollAndTop = function (element, destination, finalTop) {
    return Future.nu(function (callback) {
      ...
      var update = function (newScroll) {
        ...
        $_cva6ll118jnlf47yu.set(element, 'top', getTop(element) + ANIMATION_STEP + 'px');
      };
      var finish = function () {
        element.dom().scrollTop = destination;
        $_cva6ll118jnlf47yu.set(element, 'top', finalTop + 'px');
  ...
  var moveOnlyScroll = function (element, destination) {
    return Future.nu(function (callback) {
      var getCurrent = curry(getScrollTop, element);
      $_2u3dwzyjnlf47ja.set(element, lastScroll, getCurrent());
      var update = function (newScroll, abort) {
        var previous = $_clbvgw15ojnlf4a93.safeParse(element, lastScroll);
        if (previous !== element.dom().scrollTop) {
          abort(element.dom().scrollTop);
        } else {
          element.dom().scrollTop = newScroll;
          $_2u3dwzyjnlf47ja.set(element, lastScroll, newScroll);
        }
      };
      var finish = function () {
        element.dom().scrollTop = destination;
        $_2u3dwzyjnlf47ja.set(element, lastScroll, destination);
        callback(destination);
      };
  ...
  var moveOnlyTop = function (element, destination) {
    return Future.nu(function (callback) {
      ...
      var update = function (newTop) {
        $_cva6ll118jnlf47yu.set(element, 'top', newTop + 'px');
      };
      var finish = function () {
        update(destination);
        callback(destination);
  ...
  var updateTop = function (element, amount) {
    var newTop = amount + $_1rv28317gjnlf4b5w.getYFixedData(element) + 'px';
    $_cva6ll118jnlf47yu.set(element, 'top', newTop);
  };
  var moveWindowScroll = function (toolbar, viewport, destY) {
    var outerWindow = $_4on2xtypjnlf473t.owner(toolbar).dom().defaultView;
    return Future.nu(function (callback) {
  ...
  var scrollIntoView = function (cWin, socket, dropup, top, bottom) {
    var greenzone = $_6vtdeq17hjnlf4b6x.getGreenzone(socket, dropup);
    var refreshCursor = curry($_fssy44177jnlf4b1j.refresh, cWin);
    if (top > greenzone || bottom > greenzone) {
      $_6qsm1617bjnlf4b4w.moveOnlyScroll(socket, socket.dom().scrollTop - greenzone + bottom).get(refreshCursor);
    } else if (top < 0) {
      $_6qsm1617bjnlf4b4w.moveOnlyScroll(socket, socket.dom().scrollTop + top).get(refreshCursor);
    } else {
    }
  };
  var $_d5w4f217kjnlf4b7z = { scrollIntoView: scrollIntoView };
  ...
  var updateFixed = function (element, property, winY, offsetY) {
    ...
    $_cva6ll118jnlf47yu.set(element, property, destination + 'px');
    return Future.pure(offsetY);
  };
  var updateScrollingFixed = function (element, winY, offsetY) {
    var destTop = winY + offsetY;
    var oldProp = $_cva6ll118jnlf47yu.getRaw(element, 'top').getOr(offsetY);
    var delta = destTop - parseInt(oldProp, 10);
    var destScroll = element.dom().scrollTop + delta;
    return $_6qsm1617bjnlf4b4w.moveScrollAndTop(element, destScroll, destTop);
  };
  ...
  var register$2 = function (toolstrip, socket, container, outerWindow, structure, cWin) {
    ...
    var scrollThrottle = last$3(function () {
      scroller.idle(function () {
        $_4qyw4h17ljnlf4b85.updatePositions(container, outerWindow.pageYOffset).get(function () {
    ...
    var onScroll = $_a1t09t15ejnlf4a41.bind(Element$$1.fromDom(outerWindow), 'scroll', function () {
      if (outerWindow.pageYOffset < 0) {
        return;
      }
      scrollThrottle.throttle();
    });
    $_4qyw4h17ljnlf4b85.updatePositions(container, outerWindow.pageYOffset).get(identity);
  ...
  var setup$3 = function (bag) {
    ...
    var structure = $_1rv28317gjnlf4b5w.takeover(socket, ceBody, toolstrip, dropup);
    var keyboardModel = keyboardType(bag.outerBody(), cWin, $_49tkmtykjnlf4732.body(), contentElement, toolstrip, toolbar);
    var toEditing = function () {
    ...
    var onOrientation = $_ahfhke15djnlf4a36.onChange(outerWindow, {
      onChange: noop,
    ...
    var scrollIntoView = function (top, bottom) {
      $_d5w4f217kjnlf4b7z.scrollIntoView(cWin, socket, dropup, top, bottom);
    };
    var syncHeight = function () {
      $_cva6ll118jnlf47yu.set(contentElement, 'height', contentElement.dom().contentWindow.document.body.scrollHeight + 'px');
    };
    var setViewportOffset = function (newYOffset) {
      structure.setViewportOffset(newYOffset);
      $_6qsm1617bjnlf4b4w.moveOnlyTop(socket, newYOffset).get(identity);
    };
    var destroy = function () {
      structure.restore();
      ...
      $_7u38i8175jnlf4b0j.input($_49tkmtykjnlf4732.body(), $_d478bi103jnlf47km.blur);
    };
    return {
      toEditing: toEditing,
      toReading: toReading,
  ...
  var $_mvo77179jnlf4b2h = { setup: setup$3 };
  ...
  var create$8 = function (platform, mask) {
    ...
    var enter = function () {
      ...
      $_6q8u39169jnlf4agg.getActiveApi(platform.editor).each(function (editorApi) {
        priorState.set({
          socketHeight: $_cva6ll118jnlf47yu.getRaw(platform.socket, 'height'),
          iframeHeight: $_cva6ll118jnlf47yu.getRaw(editorApi.frame(), 'height'),
          outerScroll: document.body.scrollTop
        });
        scrollEvents.set({ exclusives: $_d3vtzu16kjnlf4anh.exclusive(doc, '.' + $_8ni6dd15bjnlf4a2j.scrollable()) });
        $_4fn1o3zwjnlf47j8.add(platform.container, $_bymmbj10vjnlf47uf.resolve('fullscreen-maximized'));
        $_a16ka216ajnlf4ahv.clobberStyles(platform.container, editorApi.body());
        meta.maximize();
        $_cva6ll118jnlf47yu.set(platform.socket, 'overflow', 'scroll');
        $_cva6ll118jnlf47yu.set(platform.socket, '-webkit-overflow-scrolling', 'touch');
        $_d478bi103jnlf47km.focus(editorApi.body());
        ...
        iosApi.set($_mvo77179jnlf4b2h.setup(setupBag({
          cWin: editorApi.win(),
          ...
          keyboardType: $_6141pm174jnlf4azu.stubborn,
        ...
        iosEvents.set($_4zgelk178jnlf4b1p.initEvents(editorApi, iosApi, platform.toolstrip, platform.socket, platform.dropup));
      });
    };
    var exit = function () {
      meta.restore();
      ...
      priorState.on(function (s) {
        s.socketHeight.each(function (h) {
          $_cva6ll118jnlf47yu.set(platform.socket, 'height', h);
        });
        s.iframeHeight.each(function (h) {
          $_cva6ll118jnlf47yu.set(platform.editor.getFrame(), 'height', h);
        });
      ...
      $_4fn1o3zwjnlf47j8.remove(platform.container, $_bymmbj10vjnlf47uf.resolve('fullscreen-maximized'));
      $_a16ka216ajnlf4ahv.restoreStyles();
      $_8ni6dd15bjnlf4a2j.deregister(platform.toolbar);
      $_cva6ll118jnlf47yu.remove(platform.socket, 'overflow');
      $_cva6ll118jnlf47yu.remove(platform.socket, '-webkit-overflow-scrolling');
      $_d478bi103jnlf47km.blur(platform.editor.getFrame());
      $_6q8u39169jnlf4agg.getActiveApi(platform.editor).each(function (editorApi) {
  ...
  var $_uk17t173jnlf4ays = { create: create$8 };

  var produce$1 = function (raw) {
    var mobile = asRawOrDie('Getting IosWebapp schema', MobileSchema, raw);
    $_cva6ll118jnlf47yu.set(mobile.toolstrip, 'width', '100%');
    $_cva6ll118jnlf47yu.set(mobile.container, 'position', 'relative');
    var onView = function () {
      mobile.setReadOnly(mobile.readOnlyOnInit());
      mode.enter();
    };
    var mask = build$1($_7zm0yv16cjnlf4aiy.sketch(onView, mobile.translate));
    mobile.alloy.add(mask);
    var maskApi = {
      show: function () {
        mobile.alloy.add(mask);
    ...
    var mode = $_uk17t173jnlf4ays.create(mobile, maskApi);
    return {
      setReadOnly: mobile.setReadOnly,
  ...
  var $_aabp93172jnlf4aya = { produce: produce$1 };

  function IosRealm (scrollIntoView) {
    var alloy = OuterContainer({ classes: [$_bymmbj10vjnlf47uf.resolve('ios-container')] });
    var toolbar = ScrollingToolbar();
    var webapp = api$2();
    var switchToEdit = $_3cbg2w16ljnlf4anz.makeEditSwitch(webapp);
    var socket = $_3cbg2w16ljnlf4anz.makeSocket();
    ...
    var init = function (spec) {
      webapp.set($_aabp93172jnlf4aya.produce(spec));
    };
    var exit = function () {
      webapp.run(function (w) {
        Replacing.remove(socket, switchToEdit);
  ...
  var $_bhm8ts17ojnlf4b8u = { derive: derive$4 };
  ...
  var fireChange$1 = function (realm, command, state) {
    realm.system().broadcastOn([$_2kjzi110bjnlf47md.formatChanged()], {
      command: command,
      state: state
    });
  };
  ...
  var $_fqsu0u17rjnlf4b9c = { fireSkinLoaded: fireSkinLoaded };

  var READING = constant('toReading');
  var EDITING = constant('toEditing');
  global$1.add('mobile', function (editor) {
    var renderUI = function (args) {
      var cssUrls = $_bhm8ts17ojnlf4b8u.derive(editor);
      if (isSkinDisabled(editor) === false) {
        editor.contentCSS.push(cssUrls.content);
        global.DOM.styleSheetLoader.load(cssUrls.ui, $_fqsu0u17rjnlf4b9c.fireSkinLoaded(editor));
      } else {
        $_fqsu0u17rjnlf4b9c.fireSkinLoaded(editor)();
      }
      var doScrollIntoView = function () {
        editor.fire('scrollIntoView');
      };
      var wrapper = Element$$1.fromTag('div');
      var realm = $_fzox1py5jnlf46zr.detect().os.isAndroid() ? AndroidRealm(doScrollIntoView) : IosRealm(doScrollIntoView);
      var original = Element$$1.fromDom(args.targetNode);
      $_8lnrdpyojnlf473r.after(original, wrapper);
      attachSystem(wrapper, realm.system());
      var findFocusIn = function (elem) {
        return $_d478bi103jnlf47km.search(elem).bind(function (focused) {
          return realm.system().getByDom(focused).toOption();
        });
      };
      var outerWindow = args.targetNode.ownerDocument.defaultView;
      var orientation = $_ahfhke15djnlf4a36.onChange(outerWindow, {
        onChange: function () {
          var alloy = realm.system();
          alloy.broadcastOn([$_2kjzi110bjnlf47md.orientationChanged()], { width: $_ahfhke15djnlf4a36.getActualWidth(outerWindow) });
        },
        onReady: noop
      });
      ...
      editor.on('init', function () {
        realm.init({
          editor: {
            ...
            onTouchContent: function () {
              var toolbar = Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_bymmbj10vjnlf47uf.resolve('toolbar')));
            ...
            onTapContent: function (evt) {
              ...
              if ($_40epr8ymjnlf473o.name(target) === 'img') {
                editor.selection.select(target.dom());
                evt.kill();
              } else if ($_40epr8ymjnlf473o.name(target) === 'a') {
                var component = realm.system().getByDom(Element$$1.fromDom(editor.editorContainer));
                component.each(function (container) {
                  if (Swapping.isAlpha(container)) {
                    $_em2mo0109jnlf47m8.openLink(target.dom());
                  }
                });
              }
            }
          ...
          toolstrip: Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_bymmbj10vjnlf47uf.resolve('toolstrip'))),
          toolbar: Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_bymmbj10vjnlf47uf.resolve('toolbar'))),
          dropup: realm.dropup(),
          alloy: realm.system(),
          translate: noop,
        ...
        var hideDropup = function () {
          realm.dropup().disappear(function () {
            realm.system().broadcastOn([$_2kjzi110bjnlf47md.dropupDismissed()], {});
          });
        };
        var backToMaskGroup = {
          label: 'The first group',
          scrollable: false,
          items: [$_69unxb10wjnlf47uk.forToolbar('back', function () {
              editor.selection.collapse();
              realm.exit();
            }, {})]
        };
        var backToReadOnlyGroup = {
          ...
          scrollable: false,
          items: [$_69unxb10wjnlf47uk.forToolbar('readonly-back', function () {
        ...
        var features = $_e8rlvg10cjnlf47mi.setup(realm, editor);
        var items = $_e8rlvg10cjnlf47mi.detect(editor.settings, features);
        var actionGroup = {
        ...
        $_23ty3m17qjnlf4b8z.init(realm, editor);
      });
      return {
