...
var modern = (function () {
  ...
  var $_bs029tu2jnlf462g = { addKeys: addKeys };
  ...
  var addContextualToolbars = function (editor) {
    ...
    var reposition = function (match, shouldShow) {
      ...
      var delta = $_dpk2g0u6jnlf462p.getUiContainerDelta(panel).getOr({
        x: 0,
        y: 0
      });
    ...
    var bindScrollEvent = function (panel) {
      if (!scrollContainer) {
        ...
        var uiContainer_1 = $_dpk2g0u6jnlf462p.getUiContainer(panel);
    ...
    var showContextToolbar = function (match) {
      ...
      panel = global$4.create({
        ...
        fixed: true,
        border: 1,
        items: $_dgog8zu9jnlf462y.createToolbar(editor, match.toolbar.items),
        oncancel: function () {
          editor.focus();
        }
      });
      $_dpk2g0u6jnlf462p.setUiContainer(editor, panel);
  ...
  var $_7lizosu3jnlf462i = { addContextualToolbars: addContextualToolbars };
  ...
  var $_99dtyduajnlf4630 = { createMenuButtons: createMenuButtons };
  ...
  var resizeTo = function (editor, width, height) {
    ...
    $_1mmzy0u1jnlf462f.fireResizeEditor(editor);
  };
  var resizeBy = function (editor, dw, dh) {
    var elm = editor.getContentAreaContainer();
    resizeTo(editor, elm.clientWidth + dw, elm.clientHeight + dh);
  };
  var $_9gw03xudjnlf463g = {
    resizeTo: resizeTo,
    resizeBy: resizeBy
  };
  ...
  var fireSkinLoaded$1 = function (editor) {
    var done = function () {
      ...
      $_1mmzy0u1jnlf462f.fireSkinLoaded(editor);
    };
    return function () {
      if (editor.initialized) {
        done();
  ...
  var $_2bwq23ugjnlf463k = { fireSkinLoaded: fireSkinLoaded$1 };
  ...
  var editAreaContainer = function (editor) {
    return {
      ...
      items: [
        editArea('0'),
        $_1za853uejnlf463i.createSidebar(editor)
      ]
    };
  };
  var render = function (editor, theme, args) {
    ...
    if (isSkinDisabled(editor) === false && args.skinUiCss) {
      DOM$2.styleSheetLoader.load(args.skinUiCss, $_2bwq23ugjnlf463k.fireSkinLoaded(editor));
    } else {
      $_2bwq23ugjnlf463k.fireSkinLoaded(editor)();
    }
      ...
      items: [
        {
          ...
          items: [
            hasMenubar(editor) === false ? null : {
              type: 'menubar',
              border: '0 0 1 0',
              items: $_99dtyduajnlf4630.createMenuButtons(editor)
            },
            $_dgog8zu9jnlf462y.createToolbars(editor, getToolbarSize(editor))
          ]
        },
        $_1za853uejnlf463i.hasSidebar(editor) ? editAreaContainer(editor) : editArea('1 0 0 0')
      ]
    });
    $_dpk2g0u6jnlf462p.setUiContainer(editor, panel);
      ...
      resizeHandleCtrl = {
        ...
        onResize: function (e) {
          if (getResize(editor) === 'both') {
            $_9gw03xudjnlf463g.resizeTo(editor, startSize.width + e.deltaX, startSize.height + e.deltaY);
          } else {
            $_9gw03xudjnlf463g.resizeTo(editor, null, startSize.height + e.deltaY);
          }
        }
      };
    }
    ...
    $_1mmzy0u1jnlf462f.fireBeforeRenderUI(editor);
    ...
    $_bs029tu2jnlf462g.addKeys(editor, panel);
    $_7lizosu3jnlf462i.addContextualToolbars(editor);
    return {
      iframeContainer: panel.find('#iframe')[0].getEl(),
      editorContainer: panel.getEl()
    };
  };
  var $_9mppkptxjnlf462a = { render: render };
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_dpk2g0u6jnlf462p.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_dpk2g0u6jnlf462p.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_jxxygumjnlf464b = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_dpk2g0u6jnlf462p.getUiContainer(self$$1);
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self$$1.borderBox = $_qrjfzusjnlf4651.parseBox(settings.border);
      self$$1.paddingBox = $_qrjfzusjnlf4651.parseBox(settings.padding);
      self$$1.marginBox = $_qrjfzusjnlf4651.parseBox(settings.margin);
      if (settings.hidden) {
        self$$1.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_dpk2g0u6jnlf462p.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self$$1.borderBox = self$$1.borderBox || $_qrjfzusjnlf4651.measureBox(elm, 'border');
      self$$1.paddingBox = self$$1.paddingBox || $_qrjfzusjnlf4651.measureBox(elm, 'padding');
      self$$1.marginBox = self$$1.marginBox || $_qrjfzusjnlf4651.measureBox(elm, 'margin');
  ...
  var render$1 = function (editor, theme, args) {
    ...
    if (isSkinDisabled(editor) === false && args.skinUiCss) {
      DOM.styleSheetLoader.load(args.skinUiCss, $_2bwq23ugjnlf463k.fireSkinLoaded(editor));
    } else {
      $_2bwq23ugjnlf463k.fireSkinLoaded(editor)();
    }
    return {};
  };
  var $_ast7c7uhjnlf463m = { render: render$1 };
  ...
  var $_4hy63uv4jnlf465z = { setup: setup };
  ...
  var renderUI = function (editor, theme, args) {
    ...
    $_4hy63uv4jnlf465z.setup(editor, theme);
    return isInline(editor) ? $_ast7c7uhjnlf463m.render(editor, theme, args) : $_9mppkptxjnlf462a.render(editor, theme, args);
  };
  var $_56icgjttjnlf4624 = { renderUI: renderUI };

  var Tooltip = Control$1.extend({
    Mixins: [$_jxxygumjnlf464b],
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_dpk2g0u6jnlf462p.inheritUiContainer(this, this._tooltip);
  ...
  var Window$$1 = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self$$1._fullscreen) {
        ...
        if (!state) {
          self$$1.borderBox = $_qrjfzusjnlf4651.parseBox(self$$1.settings.border);
          ...
          self$$1.borderBox = $_qrjfzusjnlf4651.parseBox('0');
  ...
  var get = function (editor) {
    var renderUI = function (args) {
      return $_56icgjttjnlf4624.renderUI(editor, this, args);
    };
    var resizeTo = function (w, h) {
      return $_9gw03xudjnlf463g.resizeTo(editor, w, h);
    };
    var resizeBy = function (dw, dh) {
      return $_9gw03xudjnlf463g.resizeBy(editor, dw, dh);
    };
  ...
  var isComment = function (element) {
    return type(element) === $_26w67kw7jnlf46a3.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_26w67kw7jnlf46a3.ELEMENT);
  var isText = isType$1($_26w67kw7jnlf46a3.TEXT);
  var isDocument = isType$1($_26w67kw7jnlf46a3.DOCUMENT);
  var $_8rdeknw6jnlf46a2 = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_8rdeknw6jnlf46a2.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_bn6722wejnlf46bg = { toArray: toArray };
  ...
  var $_ecc6rawhjnlf46cd = { getOrDie: getOrDie };

  var node = function () {
    var f = $_ecc6rawhjnlf46cd.getOrDie('Node');
    return f;
  };
  ...
  var $_2uk354wkjnlf46ck = { detect: detect$3 };

  var ELEMENT = $_26w67kw7jnlf46a3.ELEMENT;
  var DOCUMENT = $_26w67kw7jnlf46a3.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_8kqqdhwgjnlf46cc.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_2uk354wkjnlf46ck.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_gg1kvrwfjnlf46bi = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_29n1d8wvjnlf46e7.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_gg1kvrwfjnlf46bi.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_gg1kvrwfjnlf46bi.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_bn6722wejnlf46bg.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_bn6722wejnlf46bg.toArray(element, nextSibling);
  };
  ...
  var all$1 = function (predicate) {
    return descendants($_73u7bkw4jnlf469u.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_dg652kw8jnlf46a9.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_dg652kw8jnlf46a9.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_dg652kw8jnlf46a9.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each($_dg652kw8jnlf46a9.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_29n1d8wvjnlf46e7.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_3069pfw3jnlf469n.ancestors(scope, function (e) {
      return $_29n1d8wvjnlf46e7.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_3069pfw3jnlf469n.siblings(scope, function (e) {
      return $_29n1d8wvjnlf46e7.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_3069pfw3jnlf469n.children(scope, function (e) {
      return $_29n1d8wvjnlf46e7.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_29n1d8wvjnlf46e7.all(selector, scope);
  };
  var $_8t3z9jw2jnlf469m = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return map($_8t3z9jw2jnlf469m.descendants(Element$$1.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var $_fla8sbvzjnlf468g = { find: find$3 };
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_fla8sbvzjnlf468g.find(bodyElm);
  ...
  var first$1 = function (predicate) {
    return descendant($_73u7bkw4jnlf469u.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_gg1kvrwfjnlf46bi.eq(scope, x) && predicate(x);
    });
  };
  ...
  var first$2 = function (selector) {
    return $_29n1d8wvjnlf46e7.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_6fktuwx1jnlf46f7.ancestor(scope, function (e) {
      return $_29n1d8wvjnlf46e7.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_6fktuwx1jnlf46f7.sibling(scope, function (e) {
      return $_29n1d8wvjnlf46e7.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_6fktuwx1jnlf46f7.child(scope, function (e) {
      return $_29n1d8wvjnlf46e7.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_29n1d8wvjnlf46e7.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_29n1d8wvjnlf46e7.is, ancestor$1, scope, selector, isRoot);
  };
  var $_1zqwf1x0jnlf46f6 = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
  ...
  var $_7otxyyx3jnlf46ga = { register: register };
  ...
  var $_cfie1px5jnlf46gc = { register: register$1 };
  ...
  var $_6us709x6jnlf46ge = { register: register$2 };
  ...
  var $_64gxdex7jnlf46gh = { register: register$3 };
  ...
  var $_4nabtgx8jnlf46gl = { register: register$4 };
  ...
  var $_bvk4rbx9jnlf46go = { register: register$5 };
  ...
  var $_e0b36gxajnlf46gv = { register: register$6 };
  ...
  var $_fj6shdxbjnlf46gy = { register: register$7 };
  ...
  var $_42rcg9xcjnlf46gz = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$8.container = $_1zqwf1x0jnlf46f6.descendant(Element$$1.fromDom(document.body), editor.settings.ui_container).fold(constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup$1 = function (editor) {
    ...
    setupEnvironment();
    $_4nabtgx8jnlf46gl.register(editor);
    $_7otxyyx3jnlf46ga.register(editor);
    $_e0b36gxajnlf46gv.register(editor);
    $_fj6shdxbjnlf46gy.register(editor);
    $_6us709x6jnlf46ge.register(editor);
    $_cfie1px5jnlf46gc.register(editor);
    $_64gxdex7jnlf46gh.register(editor);
    $_42rcg9xcjnlf46gz.register(editor);
    $_bvk4rbx9jnlf46go.register(editor);
  };
  var $_asxktjwzjnlf46ew = { setup: setup$1 };
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_c83xuzjnlf465l,
      Control: Control$1,
      Factory: global$4,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_2sapsnv1jnlf465s,
      Panel: Panel,
      Movable: $_jxxygumjnlf464b,
      Resizable: $_crfyeqv3jnlf465y,
      ...
      FormatControls: $_asxktjwzjnlf46ew,
  ...
  global.add('modern', function (editor) {
    $_asxktjwzjnlf46ew.setup(editor);
    return $_4dka2ttsjnlf4622.get(editor);
  });
  function Theme () {
  }
